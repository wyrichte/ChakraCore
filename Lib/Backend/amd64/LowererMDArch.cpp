...
IR::Instr *
LowererMDArch::LoadHeapArguments(IR::Instr *instrArgs, bool force /* = false */, IR::Opnd *opndInputParamCount /* = null */)
{
    ASSERT_INLINEE_FUNC(instrArgs);
    Func *func = instrArgs->m_func;
...
int32
LowererMDArch::LowerCallArgs(IR::Instr *callInstr, ushort callFlags, Js::ArgSlot extraParams, IR::IntConstOpnd **callInfoOpndRef /* = null */)
{
...
LowererMDArch::LowerCallI(IR::Instr * callInstr, ushort callFlags, bool isHelper, IR::Instr * insertBeforeInstrForCFG)
{
    ...
    else if (insertBeforeInstrForCFG != null)
    {
...
LowererMDArch::LowerAsmJsLdElemHelper(IR::Instr * instr)
{
    ...
    {
        // TODO: remove bound check for const load
...
LowererMDArch::LowerAsmJsStElemHelper(IR::Instr * instr)
{
    ...
    {
        // TODO: remove bound check for const store
        Assert(!m_func->GetJnFunction()->GetAsmJsFunctionInfo()->IsHeapBufferConst());
        IR::LabelInstr * helperLabel = Lowerer::InsertLabel(true, instr);
...
LowererMDArch::GenerateStackAllocation(IR::Instr *instr, uint32 size)
{
    ...
    IR::RegOpnd *       rspOpnd         = IR::RegOpnd::New(NULL, RegRSP, TyMachReg, this->m_func);
    ...
    else
    {
        ...
        IR::RegOpnd *raxOpnd = IR::RegOpnd::New(NULL, RegRAX, TyMachReg, this->m_func);
        IR::RegOpnd *rcxOpnd = IR::RegOpnd::New(NULL, RegRCX, TyMachReg, this->m_func);
        IR::RegOpnd *rspOpnd = IR::RegOpnd::New(NULL, RegRSP, TyMachReg, this->m_func);
...
LowererMDArch::MovArgFromReg2Stack(IR::Instr * instr, RegNum reg, uint16 slotNumber, IRType type)
{
    ...
    IR::RegOpnd *       src       = IR::RegOpnd::New(NULL, reg, type,  this->m_func);
...
LowererMDArch::LowerEntryInstr(IR::EntryInstr * entryInstr)
{
    ...
    uint savedRegSize           = 0;
    IR::Instr *firstPrologInstr = null;
    IR::Instr *lastPrologInstr  = null;
    ...
    for (RegNum reg = (RegNum)(RegNOREG + 1); reg < RegNumCount; reg = (RegNum)(reg + 1))
    {
        if ((LinearScan::IsCalleeSaved(reg) && (this->m_func->HasTry() || this->m_func->m_regsUsed.Test(reg))))
        {
            ...
            IR::RegOpnd *regOpnd   = IR::RegOpnd::New(null, reg, type, this->m_func);
    ...
    IR::Instr *movRax0 = NULL;
    IR::Opnd *raxOpnd = NULL;
    if (this->m_func->HasArgumentSlot())
    {
        // TODO: Support mov [rbp - n], IMM64
        raxOpnd = IR::RegOpnd::New(null, RegRAX, TyUint32, this->m_func);
    ...
    IR::RegOpnd * rbpOpnd = IR::RegOpnd::New(NULL, RegRBP, TyMachReg, this->m_func);
    IR::RegOpnd * rspOpnd = IR::RegOpnd::New(NULL, RegRSP, TyMachReg, this->m_func);
...
LowererMDArch::GeneratePrologueStackProbe(IR::Instr *entryInstr, IntConstType frameSize)
{
    ...
    if (doInterruptProbe || !threadContext->GetIsThreadBound() || !this->m_func->IsInMemory())
    {
        ...
        if (!this->m_func->IsInMemory())
        {
            ...
            IR::RegOpnd *javascriptFunctionOpnd = IR::RegOpnd::New(null, RegRCX, TyMachReg, this->m_func);
            this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(javascriptFunctionOpnd, Js::JavascriptFunction::GetTypeOffset(), TyMachReg, this->m_func), insertInstr);
            this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(baseOpnd, Js::Type::GetJavascriptLibraryOffset(), TyMachReg, this->m_func), insertInstr);
            this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(baseOpnd, Js::JavascriptLibrary::GetScriptContextOffset(), TyMachReg, this->m_func), insertInstr);
            this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(baseOpnd, Js::ScriptContext::GetThreadContextOffset(), TyMachReg, this->m_func), insertInstr);
        ...
        else
        {
            ...
            IR::RegOpnd *baseOpnd = IR::RegOpnd::New(null, RegRAX, TyMachReg, this->m_func);
            // RELOCJIT: This is OK because relocation will be handled in another branch of this if.
    ...
    instr->SetSrc1(IR::RegOpnd::New(null, GetRegStackPointer(), TyMachReg, m_func));
    ...
    {
        // MOV rdx, scriptContext
        IR::RegOpnd *baseOpnd = IR::RegOpnd::New(null, RegRDX, TyMachReg, this->m_func);
        IR::RegOpnd *javascriptFunctionOpnd = IR::RegOpnd::New(null, RegRCX, TyMachReg, this->m_func);
        this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(javascriptFunctionOpnd, Js::JavascriptFunction::GetTypeOffset(), TyMachReg, this->m_func), insertInstr);
        this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(baseOpnd, Js::Type::GetJavascriptLibraryOffset(), TyMachReg, this->m_func), insertInstr);
        this->lowererMD->CreateAssign(baseOpnd, IR::IndirOpnd::New(baseOpnd, Js::JavascriptLibrary::GetScriptContextOffset(), TyMachReg, this->m_func), insertInstr);
        ...
        // MOV rax, ThreadContext::ProbeCurrentStack
        target = IR::RegOpnd::New(null, RegRAX, TyMachReg, m_func);
        this->lowererMD->CreateAssign(target, IR::IndirOpnd::New(javascriptFunctionOpnd, Js::JavascriptFunction::GetTypeOffset(), TyMachReg, this->m_func), insertInstr);
        this->lowererMD->CreateAssign(target, IR::IndirOpnd::New(target, Js::Type::GetJavascriptLibraryOffset(), TyMachReg, this->m_func), insertInstr);
        this->lowererMD->CreateAssign(target, IR::IndirOpnd::New(target, Js::JavascriptLibrary::GetJnHelperMethodsOffset(), TyMachReg, this->m_func), insertInstr);
        this->lowererMD->CreateAssign(target, IR::IndirOpnd::New(target, IR::HelperProbeCurrentStack * sizeof(void *), TyMachReg, this->m_func), insertInstr);

        // MOV rcx, frameSize
        this->lowererMD->CreateAssign(
            IR::RegOpnd::New(null, RegRCX, TyMachReg, this->m_func),
    ...
    else
    {
        // MOV rdx, scriptContext
        this->lowererMD->CreateAssign(
            IR::RegOpnd::New(null, RegRDX, TyMachReg, m_func),
...
LowererMDArch::LowerExitInstr(IR::ExitInstr * exitInstr)
{
    ...
    if (m_func->GetJnFunction()->GetIsAsmjsMode() && !m_func->IsLoopBody())
    {
        ...
        case Js::AsmJsRetType::Float:
            retReg = IR::RegOpnd::New(NULL, this->GetRegReturnAsmJs(TyMachDouble), TyMachDouble, this->m_func);
            break;
#ifdef SIMD_JS_ENABLED
        ...
        case Js::AsmJsRetType::Void:
            retReg = IR::RegOpnd::New(NULL, this->GetRegReturn(TyMachReg), TyMachReg, this->m_func);
            break;
        default:
            Assume(UNREACHED);
        }
...
LowererMDArch::EmitLoadVar(IR::Instr *instrLoad, bool isFromUint32, bool isHelper)
{
    ...
    IR::LabelInstr *toVar = null;
    IR::LabelInstr *done  = null;
    ...
    if (!isInt)
    {
        ...
        // ToVar()
        this->lowererMD->EmitLoadVarNoCheck(dst->AsRegOpnd(), src1, instrLoad, isFromUint32, isHelper || toVar != null);
    }
...
LowererMDArch::LowerEHRegionReturn(IR::Instr * insertBeforeInstr, IR::Opnd * targetOpnd)
{
    ...
    IR::Instr *movR8 = IR::Instr::New(Js::OpCode::LdSpillSize,
        IR::RegOpnd::New(null, RegR8, TyMachReg, m_func),
        m_func);
    ...
    IR::Instr *movR9 = IR::Instr::New(Js::OpCode::LdArgSize,
        IR::RegOpnd::New(null, RegR9, TyMachReg, m_func),
        m_func);
