    ...
    namespace Internal {
        namespace Performance {
            ...
            perfDac_ImportDac_DatabaseValidated = 21216,
                    ...
                    perfVSTF_BeginSyncSession = 22500,                   
                    perfVSTF_EndSyncSession = 22501,                     
                    perfVSTF_BeginSync = 22502,                          
                    perfVSTF_EndSync = 22503,                            
                    perfVSTF_BeginGetChangeBatch = 22504,                
                    perfVSTF_EndGetChangeBatch = 22505,                  
                    perfVSTF_BeginProcessChangeBatch = 22506,            
                    perfVSTF_EndProcessChangeBatch = 22507,              
                    perfVSTF_BeginReadChangedProjectList = 22508,        
                    perfVSTF_EndReadChangedProjectList = 22509,          
                    perfVSTF_BeginReadProjectChanges = 22510,            
                    perfVSTF_EndReadProjectChanges = 22511,              
                    perfVSTF_BeginReadProjectProperties = 22512,         
                    perfVSTF_EndReadProjectProperties = 22513,           
                    perfVSTF_BeginReadSavedAssignments = 22514,          
                    perfVSTF_EndReadSavedAssignments = 22515,            
                    perfVSTF_BeginReadApprovalsList = 22516,             
                    perfVSTF_EndReadApprovalsList = 22517,               
                    perfVSTF_BeginReadApprovals = 22518,                 
                    perfVSTF_EndReadApprovals = 22519,                   
