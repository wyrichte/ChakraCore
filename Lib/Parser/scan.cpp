    ...
    EncodedCharPtr pchMin, EncodedCharPtr p, EncodedCharPtr *pp)
{
    ...
    *pp = p;
    ...
    if (!fHasEscape)
    {
        ...
        // yield if m_fYieldIsKeyword is false, in which case yield is treated as an identifier).
    ...
    return tk == tkID || (tk == tkYIELD && !m_fYieldIsKeyword) ? tkID : tkNone;
}
