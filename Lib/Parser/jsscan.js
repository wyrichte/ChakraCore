// WARNING: See OSG VSO Bug 1335253 ( https://microsoft.visualstudio.com/DefaultCollection/OS/_workItems/index#id=1335253&triage=true&_a=edit )
// This file will not generate Trie branches when symbols share prefixes under certain circumstances (thus skipping cases).
// Feel free to fix this bug if you are editing this file.
...
function emitToken(token, d, indent) {
    ...
    if (token.res == 1) {
        ...
        // these are tokens that are classified as keywords only for colorizing
        r += indent + "if (!this->m_parser) {" + "\r\n";
        r += indent + "    " + "token = " + token.tk + ";\r\n";
        r += indent + "    " + "goto LReserved;\r\n";
        r += indent + "}\r\n";
        r += indent + "goto LIdentifier;\r\n";
...
if (objArgs.length != 1 && objArgs.length != 2) {
    ...
    file.Close();
    var reg = /KEYWORD\((tk[A-Z]+)\s*,(1|2|4),.*,\s*([a-z]+)\)/g;
    ...
    var indent = "    ";
    var r = "// Copyright (C) Microsoft. All rights reserved.\r\n// GENERATED FILE, DO NOT HAND MODIFIY\r\n// Generated with the following command line: wscript jsscan.js " + objArgs(0) + " " + objArgs(1) + "\r\n// This should be regenerated whenever the keywords change\r\n\r\n";
