...
// Function Calls
  ...
  DEF2_WMS( F1toF1Mem        , Ceil_Flt     , ::ceil                                             )
  DEF2_WMS( D1toD1Mem        , Floor_Db     , ::floor                                            )
  DEF2_WMS( F1toF1Mem        , Floor_Flt    , ::floor                                            )
  ...
  DEF2_WMS( F1toF1Mem        , Sqrt_Flt     , ::sqrt                                             )
  DEF2_WMS( D1toD1Mem        , Abs_Db       , ::abs                                              )
  DEF2_WMS( F1toF1Mem        , Abs_Flt      , ::abs                                              )
