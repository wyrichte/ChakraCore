...
namespace Js
{
    ...
    namespace SSE2
    {
        ...
        public:
            ...
            static Var Increment_InPlace(Var aRight,ScriptContext* scriptContext, __out JavascriptNumber* result);
            ...
            static Var Decrement_InPlace(Var aRight,ScriptContext* scriptContext, __out JavascriptNumber* result);

            static Var Negate(Var aRight,ScriptContext* scriptContext);
            static Var Negate_Full(Var aRight,ScriptContext* scriptContext);
            static Var Negate_InPlace(Var aRight,ScriptContext* scriptContext, __out JavascriptNumber* result);

            static Var Not(Var aRight,ScriptContext* scriptContext);
            static Var Not_Full(Var aRight,ScriptContext* scriptContext);
            static Var Not_InPlace(Var aRight,ScriptContext* scriptContext, __out JavascriptNumber* result);
            ...
            static Var Add_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
            static Var AddLeftDead(Var aLeft, Var aRight,ScriptContext* scriptContext, __out_opt JavascriptNumber *result);

            static Var MulAddLeft(Var mulLeft, Var mulRight, Var addLeft, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var MulAddRight(Var mulLeft, Var mulRight, Var addRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var MulSubLeft(Var mulLeft, Var mulRight, Var subLeft, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var MulSubRight(Var mulLeft, Var mulRight, Var subRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            ...
            static Var Subtract_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
            ...
            static Var Multiply_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
            ...
            static Var And_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
            ...
            static Var Or_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
            ...
            static Var Xor_InPlace(Var aLeft, Var aRight,ScriptContext* scriptContext, __out JavascriptNumber *result);
        ...
        private:
            static Var Add_FullHelper(Var aLeft, Var aRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result, bool leftIsDead);
            static Var Add_FullHelper_Wrapper(Var aLeft, Var aRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result, bool leftIsDead);
            ...
            static Var Add_DoubleHelper(double dblLeft, Var addRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var Add_DoubleHelper(Var addLeft, double dblRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var Subtract_DoubleHelper(double dblLeft, Var subRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
            static Var Subtract_DoubleHelper(Var subLeft, double dblRight, ScriptContext* scriptContext, __out_opt JavascriptNumber* result);
