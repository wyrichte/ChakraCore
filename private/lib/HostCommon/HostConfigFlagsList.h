...
FLAG(bool, MapScriptFile,                   "Map the script file into memory", false)
...
FLAG(bool, PerformBytecodeExpressionTest,   "Executes the script as a bytecode buffer returning an expression. Prints the resulting expression to stdout.", false)
...
FLAG(bool, TraceMemoryBuffer,               "Trace calls in JsHostMemoryMappedBuffer implementation", false)
