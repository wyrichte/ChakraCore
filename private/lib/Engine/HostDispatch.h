...
public:
    ...
    virtual BOOL GetEnumerator(Js::JavascriptStaticEnumerator * enumerator, Js::EnumeratorFlags flags, Js::ScriptContext* requestContext, Js::EnumeratorCache * forInCache = nullptr) override;
