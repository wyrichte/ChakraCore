...
#define END_CUSTOM_EXTERNAL_OBJECT_CALL(scriptContext, thisTypeId, propertyId, Operation) \
    ...
    public:
        ...
        virtual BOOL GetEnumerator(JavascriptStaticEnumerator * enumerator, EnumeratorFlags flags, ScriptContext* requestContext, EnumeratorCache * enumeratorCache) override;
