// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JavaScriptContext.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public struct JavaScriptContext
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether the context is invalid.
        /// </summary>
        ...
        {
            var bufferSize = buffer == null ? 0 : (ulong)buffer.Length;
        ...
        /// <summary>
        ///     Stops debugging in the context.
        /// </summary>
        public static void StopDebugging()
        {
            Native.ThrowIfError(Native.JsStopDebugging());
        }
