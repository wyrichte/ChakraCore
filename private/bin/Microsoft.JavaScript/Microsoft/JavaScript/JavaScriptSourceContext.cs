// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JavaScriptSourceContext.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public struct JavaScriptSourceContext : IEquatable<JavaScriptSourceContext>
    {
        ...
        {
            return New(context.context - offset);
        }
        ...
        public static JavaScriptSourceContext New(IntPtr cookie)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is JavaScriptSourceContext && this.Equals((JavaScriptSourceContext)obj);
        }
