...
echo powershell.exe -ExecutionPolicy Bypass %BUNDLEROOT%\RunJSDRT.ps1 -RunUnitTests $False -RunCoreUnitTests $True -RunHtmlUnitTests $False -RunJsrtUnitTests $False -DrtBundleRoot %BUNDLEROOT% -DrtMode $True -BuildArch %ARCH% -BuildFlavor %FLAVOR% -LogsRootDir %LOGSDIR% -Dirs Function`,LetConst`,SIMD.float32x4`,SIMD.int32x4`,SIMD.int8x16`,SIMD.float32x4.asmjs`,SIMD.int32x4.asmjs`,SIMD.int16x8.asmjs`,SIMD.workloads.asmjs`,SIMD.TypeSpec
powershell.exe -ExecutionPolicy Bypass %BUNDLEROOT%\RunJSDRT.ps1 -RunUnitTests $False -RunCoreUnitTests $True -RunHtmlUnitTests $False -RunJsrtUnitTests $False -DrtBundleRoot %BUNDLEROOT% -DrtMode $True -BuildArch %ARCH% -BuildFlavor %FLAVOR% -LogsRootDir %LOGSDIR% -Dirs Function`,LetConst`,SIMD.float32x4`,SIMD.int32x4`,SIMD.int8x16`,SIMD.float32x4.asmjs`,SIMD.int32x4.asmjs`,SIMD.int16x8.asmjs`,SIMD.workloads.asmjs`,SIMD.TypeSpec
