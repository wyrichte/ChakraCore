...
call %_RootDir%\core\test\runtests.cmd -binary jshost.exe -binDir %_RootDir%\Build\VcBuild\Bin -nottags html -nottags exclude_nonrazzle -nottags exclude_jshost -nottags require_winglob %*
popd
