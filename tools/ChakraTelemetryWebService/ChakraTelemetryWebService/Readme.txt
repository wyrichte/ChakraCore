ChakraTelemetryWebService Prerequisites

The ChakraTelemetryWebService project is set to automatically run StyleCop, Code Analysis, and utilizes Code Contracts
