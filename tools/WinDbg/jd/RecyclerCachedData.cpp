...
Addresses * RecyclerCachedData::GetRootPointers(RemoteRecycler recycler, RemoteThreadContext * threadContext)
{
    ...
    Addresses * rootPointers = ComputeRoots(recycler, threadContext);
