   ...
   "last : number = '35'"
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verify(Animals.Phylum.placozoa, 1920954, 'Animals.Phylum.placozoa');
            // Reset to default value
            Animals.Phylum.placozoa = 27;
        }
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            // Enums are extensible so the expected object will change
            // deep copy
            var phylumWithHedgeHog = [];
            for (var e in phylum) {
                phylumWithHedgeHog.push(phylum[e]);
            }
            phylumWithHedgeHog.push("popcorn : string = 'Hedgehog'");
            verifyObject(Animals.Phylum, phylumWithHedgeHog, 'object');

            delete Animals.Phylum.popcorn;
            verifyObject(Animals.Phylum, phylum, 'object');
        }
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verifyObject(Animals.Phylum, phylumWithDelete, 'object');
            // Re-add pacozoa
            Animals.Phylum.placozoa = 27;
        }
