...
(function () {
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verify.noException(function() {
                instance.win8EnumIn(DevTests.Versioning.MinVersionEnum.min);
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            */
            ...
            // callWin8Delegate still has an invalid signature, because the delegate's 
    ...
    Loader42_FileName = 'Marshaling Versioned Types Test - Version NTDDI_WIN8';
})();
