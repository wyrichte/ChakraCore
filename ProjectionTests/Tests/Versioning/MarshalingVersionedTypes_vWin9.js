...
(function () {
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            // callWin8SP1Delegate still has an invalid signature, because the delegate's 
            // parameter is outside the target version
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            }, "minVersionInterfaceVectorIn should succeed for this target version");

            verify.noException(function() {
                instance.win8InterfaceVectorIn(interfaceVector);
            }, "win8InterfaceVectorIn should succeed for this target version");

            verify.noException(function() {
                instance.win8SP1InterfaceVectorIn(interfaceVector);
            }, "win8SP1InterfaceVectorIn should succeed for this target version");

            verify.noException(function() {
                instance.win9InterfaceVectorIn(interfaceVector);
            }, "win9InterfaceVectorIn should succeed for this target version");

            // All other *InterfaceVectorIn methods will have invalid signatures, because the 
            // parameter type is outside the target version
            verify.exception(function() {
    ...
    Loader42_FileName = 'Marshaling Versioned Types Test - Version NTDDI_MOCK_WIN9';
})();
