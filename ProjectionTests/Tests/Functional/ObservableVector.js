...
(function () {
    ...
    function GetVector() {
        logger.comment("myVector = myAnimal.getObservableVector();");
        myVector = myAnimal.getObservableVector();
    ...
    runner.addTest({
        id: 2,
        desc: 'ObservableVectorAsArray_Index_length',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 3,
        desc: 'ObservableVectorAsArray_Push_Pop',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [];
    ...
    runner.addTest({
        id: 4,
        desc: 'ObservableVectorAsArray_Shift_Unshift',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 5,
        desc: 'ObservableVectorAsArray_Slice',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 6,
        desc: 'ObservableVectorAsArray_Splice',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 33, 44, 55, 66, 77, 11, 22, 33, 44, 55, 66, 100, 100];
    ...
    runner.addTest({
        id: 7,
        desc: 'ObservableVectorAsArray_Every',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 8,
        desc: 'ObservableVectorAsArray_Some',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 9,
        desc: 'ObservableVectorAsArray_Filter',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 10,
        desc: 'ObservableVectorAsArray_ForEach',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 11,
        desc: 'ObservableVectorAsArray_Map',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 12,
        desc: 'ObservableVectorAsArray_Reduce_ReduceRight',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 13,
        desc: 'ObservableVectorAsArray_Reverse_Sort',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 14,
        desc: 'ObservableVectorAsArray_Concat',
        pri: '0',
        test: function () {
            GetVector();
            ...
            logger.comment("var mySecondVector = myAnimal.getObservableVector();");
            var mySecondVector = myAnimal.getObservableVector();
    ...
    runner.addTest({
        id: 15,
        desc: 'ObservableVectorAsArray_Join',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 16,
        desc: 'ObservableVectorAsArray_IndexOf',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 17,
        desc: 'ObservableVectorAsArray_LastIndexOf',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 18,
        desc: 'ObservableVectorAsArray_IsArray_Apply',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 19,
        desc: 'ObservableVectorAsArray_PropertyOperations',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 20,
        desc: 'ObservableVectorAsArray_Prototype',
        pri: '0',
        test: function () {
            GetVector();
            dumpVector(myVector, "myVector");
    ...
    runner.addTest({
        id: 21,
        desc: 'ObservableVectorAsArray_Events',
        pri: '0',
        test: function () {
            GetVector();
            dumpVector(myVector, "myVector");
            ...
            // Remove the event handler and see there is no error
            logger.comment("myVector.removeEventListener('vectorchanged', vectorChanged);");
            myVector.removeEventListener('vectorchanged', vectorChanged);

            logger.comment("myVector[0] = 24;");
            myVector[0] = 24;
            verifyVectorAndArrayItems("myVector", myVector, [24]);
        }
    });

    Loader42_FileName = 'Observable Vector Collections test';
})();
