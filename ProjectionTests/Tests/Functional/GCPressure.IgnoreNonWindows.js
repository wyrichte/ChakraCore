...
(function () {
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verify(TestUtilities.GetMemoryFootprintOfRC("DevTests.GCPressure.SmallClass"), GCPressure.none, "Memory Footprint of DevTests.GCPressure.SmallClass");
        }
    });
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verify(TestUtilities.GetMemoryFootprintOfRC("DevTests.GCPressure.MediumClass"), GCPressure.none, "Memory Footprint of DevTests.GCPressure.MediumClass");
        }
    });
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            verify(TestUtilities.GetMemoryFootprintOfRC("DevTests.GCPressure.LargeClass"), GCPressure.none, "Memory Footprint of DevTests.GCPressure.LargeClass");
        }
    });

    Loader42_FileName = "GCPressureAttribute consumption tests - Ignore non-Windows types";
})();
