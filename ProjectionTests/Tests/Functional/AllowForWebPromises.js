///<reference path="..\\projectionsglue.js"/>
if (typeof WScript !== 'undefined' && typeof WScript.LoadScriptFile !== 'undefined') { WScript.LoadScriptFile("..\\projectionsglue.js"); }
(function () {
    function testLibraryStackFrame() {
        function trimPath(line) {
            return line && line.replace(/(\(.+tests.Functional.)|(\(.+projectiontests.tests.)/ig, "(");
        }
        ...
        try {
            ...
            logger.comment(trimPath(e.stack));
        }
    ...
    function getAsyncOperation() {
        // We can't use new to activate instances of WinRT objects in the Web View host, so get an instance from TestUtilities
        var winery = TestUtilities.RWineryToVar();
        return winery.allowForWebAsyncOperationOut();
    }
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            if (errorResult.asyncOpType != "Winery.AllowForWebCustomAsyncInfo") {
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            promise.operation.moveToCompleted(192); // Both 'dones' should be called.
            if (completeCalled != "first second") {
                fail("expected completeCalled");
            }
        }
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            promise.operation.moveToCompleted(null); // Both 'dones' should be called.
            if (completeCalled != "first second") {
                fail("expected completeCalled");
            }
        }
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            promise.operation.moveToCompleted(null); // Complete before the next 'done' is attached. Second should still get called
            promise
                .done(function (result) {
                    completeCalled = completeCalled + "second";
                    testLibraryStackFrame();
        ...
        test: function () {
            ...
            promise
                .then(
                    ...
                    function (result) { errorCalled = errorCalled + "onError(" + result + ")"; testLibraryStackFrame(); },
                    function (percent) { progressCalled = progressCalled + "onProgress(" + percent + ")"; testLibraryStackFrame(); }
                );
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            var chainedPromise = getAsyncOperation();
    ...
    Loader42_FileName = "AllowForWeb - Promises tests";
})();
