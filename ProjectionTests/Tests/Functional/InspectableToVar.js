...
(function () {
    ...
    runner.addTest({
        ...
        test: function () {
            var myAnimal = TestUtilities.AnimalToVar();
            verify(myAnimal.constructor, Animals.Animal, 'myAnimal.constructor');
            verifyMembers(myAnimal, animalMembersExpected, 'object');
        }
    });

    // TODO: Add test for VectorIntToVar after WIN8: 236649 is resolved

    Loader42_FileName = 'InspectableUnknownToVar tests';
})();
