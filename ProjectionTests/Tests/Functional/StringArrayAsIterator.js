...
(function () {
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            logger.comment("var myIterator = (new Animals.Animal(1)).duplicateStringIterator(myArray);");
            var myAnimal = new Animals.Animal(1);
            var myIterator = myAnimal.duplicateStringIterator(myArray);
            logger.comment('verifyIterator("myIterator", myIterator, ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"])');
            verifyIterator("myIterator", myIterator, ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"]);

            logger.comment("Iterator with getMany");
            var myIterator = myAnimal.duplicateStringIterator(myArray);
            verifyIteratorRangeWithGetMany("myIterator", myIterator, ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"]);
        }
    });
    ...
    runner.addTest({
        ...
        test: function () {
            ...
            var myArray = ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"]; ;
            logger.comment("var myIterator = (new Animals.Animal(1)).duplicateStringIterator(myArray);");
            var myIterator = (new Animals.Animal(1)).duplicateStringIterator(myArray);
    ...
    runner.addTest({
        ...
        test: function () {
            logger.comment('var myArray = ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"];');
            var myArray = ["Pink", "Yellow", "Blue", "Red", "Green", "Brown", "Tan", "Black", "White"];
            logger.comment("var myIterator = (new Animals.Animal(1)).sendBackSameStringIterator(myArray);");
            var myIterator = (new Animals.Animal(1)).sendBackSameStringIterator(myArray);
    ...
    Loader42_FileName = 'String array as Iterator tests';
})();
