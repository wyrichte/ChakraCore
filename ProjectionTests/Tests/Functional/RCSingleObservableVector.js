...
(function () {
    ...
    function GetVector() {
        logger.comment("myVector = new Animals.RCISingleObservable();");
        myVector = new Animals.RCISingleObservable();
    ...
    runner.addTest({
        id: 1,
        desc: 'MarshalRCSingleObservableVector',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 2,
        desc: 'RCSingleObservableVectorAsArray_Index_length',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 3,
        desc: 'RCSingleObservableVectorAsArray_Push_Pop',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [];
    ...
    runner.addTest({
        id: 4,
        desc: 'RCSingleObservableVectorAsArray_Shift_Unshift',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 5,
        desc: 'RCSingleObservableVectorAsArray_Slice',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 6,
        desc: 'RCSingleObservableVectorAsArray_Splice',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 33, 44, 55, 66, 77, 11, 22, 33, 44, 55, 66, 100, 100];
    ...
    runner.addTest({
        id: 7,
        desc: 'RCSingleObservableVectorAsArray_Every',
        pri: '0',
        test: function () {
            GetVector();
    ...
    runner.addTest({
        id: 8,
        desc: 'RCSingleObservableVectorAsArray_Some',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 9,
        desc: 'RCSingleObservableVectorAsArray_Filter',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 10,
        desc: 'RCSingleObservableVectorAsArray_ForEach',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 11,
        desc: 'RCSingleObservableVectorAsArray_Map',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 12,
        desc: 'RCSingleObservableVectorAsArray_Reduce_ReduceRight',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 13,
        desc: 'RCSingleObservableVectorAsArray_Reverse_Sort',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [0, 22, 14, 98, 54, 55, 11, 22, 33, 44, 55, 66, 100, 100, 100, 100];
    ...
    runner.addTest({
        id: 14,
        desc: 'RCSingleObservableVectorAsArray_Concat',
        pri: '0',
        test: function () {
            GetVector();
            ...
            logger.comment("var mySecondVector = new Animals.RCISingleObservable();");
            var mySecondVector = new Animals.RCISingleObservable();
    ...
    runner.addTest({
        id: 15,
        desc: 'RCSingleObservableVectorAsArray_Join',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 16,
        desc: 'RCSingleObservableVectorAsArray_IndexOf',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 17,
        desc: 'RCSingleObservableVectorAsArray_LastIndexOf',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 18,
        desc: 'RCSingleObservableVectorAsArray_IsArray_Apply',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 19,
        desc: 'RCSingleObservableVectorAsArray_PropertyOperations',
        pri: '0',
        test: function () {
            GetVector();
            myArray = [98, 66, 55, 55, 54, 44, 33, 22, 22, 14, 11, 100, 100, 100, 100, 0];
    ...
    runner.addTest({
        id: 20,
        desc: 'RCSingleObservableVectorAsArray_Prototype',
        pri: '0',
        test: function () {
            GetVector();
            dumpVector(myVector, "myVector");
    ...
    runner.addTest({
        id: 21,
        desc: 'RCSingleObservableVectorAsArray_Events',
        pri: '0',
        test: function () {
            GetVector();
            dumpVector(myVector, "myVector");
    ...
    Loader42_FileName = 'RCSingleObservable Vector Collections test';
})();
