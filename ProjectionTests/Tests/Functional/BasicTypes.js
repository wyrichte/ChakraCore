...
(function () {
    ...
    var E_INVALIDARG = "TypeError: Invalid procedure call or argument";
    if((typeof navigator !== 'undefined') // for wwahost run
        && (navigator.userAgent.match(/Windows NT 6\.2/) !== null)) // win8 + wwahost
    {
        E_INVALIDARG = "TypeError: Could not convert argument to type 'char'";
    }
    ...
    ["Char16", null, E_INVALIDARG],
    ["Char16", '', E_INVALIDARG],
    ["Char16", "ab", E_INVALIDARG],
    ["Char16", 92, E_INVALIDARG],
    ...
    for (i in typeTests) {
        ...
        runner.addTest({
            ...
            test: function () {
                try {
                    typeof TestUtilities !== 'undefined' && TestUtilities.ClearAllProjectionCaches();
