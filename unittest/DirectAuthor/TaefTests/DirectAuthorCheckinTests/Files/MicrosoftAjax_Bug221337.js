...
Date.localeParse = function Date$localeParse(value, formats) {
    /// <param name="value" type="String"></param>
...
Date._parseExact = function Date$_parseExact(value, format, cultureInfo) {
    ...
    var match = new RegExp(parseInfo.regExp).exec(value);
        ...
        if (tzMinOffset !== null) {
            ...
            result.setMinutes(result.getMinutes() - tzMinOffset);
        }
        return result;
    }
}
...
Number.localeParse = function Number$localeParse(value) {
    /// <param name="value" type="String"></param>
...
Number._parse = function Number$_parse(value, cultureInfo) {
    ...
    if (!valueStr.match(numberFormatRegex)) {
        ...
        var regex = new RegExp("\\" + decSeparator + "|\\" + grpSeparator, "g");
    
            var ret = new Sys.StringBuilder("");
    var index = 0;
    var ar = null;
    while ((ar = regex.exec(valueStr)) !== null) {
        ret.append(valueStr.slice(index, ar.index));
                if (ar[0] === decSeparator) {
            ret.append(".");
        }
        index = regex.lastIndex;
    }
    ret.append(valueStr.slice(index));
    var result = parseFloat(ret);
    if (isNaN(result)) {
        throw Error.format(Sys.Res.formatInvalidString);
    }
    return result;
...
Sys.StringBuilder = function Sys$StringBuilder(initialText) {
    ...
    function Sys$StringBuilder$toString(separator) {
        ...
        separator = separator || '';
        if (typeof(this._value[separator]) === 'undefined') this._value[separator] = this._parts.join(separator);
...
Error.scriptLoadFailed = function Error$scriptLoadFailed(scriptUrl, multipleCallbacks) {
    /// <param name="scriptUrl" type="String"></param>
    /// <param name="multipleCallbacks" type="Boolean" optional="true"></param>
    /// <returns></returns>
    var e = Function._validateParams(arguments, [
        {name: "scriptUrl", type: String},
        {name: "multipleCallbacks", type: Boolean, optional: true}
    ]);
    if (e) throw e;
...
Sys.UI.DomEvent = function Sys$UI$DomEvent(eventObject) {
    ...
    if (this.target) {
        ...
        this.offsetX = (typeof(e.offsetX) !== 'undefined') ? e.offsetX : window.pageXOffset + e.clientX - loc.x;
        this.offsetY = (typeof(e.offsetY) !== 'undefined') ? e.offsetY : window.pageYOffset + e.clientY - loc.y;
    }
...
Sys._ScriptLoader = function Sys$_ScriptLoader() {
    ...
    function Sys$_ScriptLoader$_raiseError(multipleCallbacks) {
        ...
        if(callback) {
            ...
            throw Error.scriptLoadFailed(scriptElement.src, multipleCallbacks);
        }
    }
...
Sys._Application = function Sys$_Application() {
    ...
    function Sys$_Application$_scriptLoadFailedHandler(scriptLoader, scriptElement, multipleCallbacks) {
        if(this._disposing) {
                        return;
        }
        var cancelled = false;
...
Sys.Net.WebServiceProxy.invoke = function Sys$Net$WebServiceProxy$invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext, timeout) {
    ...
    /// <param name="onFailure" type="Function" mayBeNull="true" optional="true"></param>
    /// <param name="userContext" mayBeNull="true" optional="true"></param>
    /// <param name="timeout" optional="true"></param>
    /// <returns type="Sys.Net.WebRequest"></returns>
    var e = Function._validateParams(arguments, [
        {name: "servicePath", type: String},
        {name: "methodName", type: String},
...
Sys.UI.DomElement.getBounds = function Sys$UI$DomElement$getBounds(element) {
    ...
    return new Sys.UI.Bounds(offset.x, offset.y, element.offsetWidth, element.offsetHeight);
}
