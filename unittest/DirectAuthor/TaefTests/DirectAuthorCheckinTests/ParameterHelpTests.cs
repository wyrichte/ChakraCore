...
namespace DirectAuthorCheckinTests
{
    ...
    // to the derived class, ParameterHelpTestsWithExtensions.
...
function MissingSignatureClosingTag() {
    ...
    missingSignatureClosingTag(|);
        ...
        {
            var domjs = _session.ReadFile(Paths.DomWebPath).Text;
            var jQuery = JQueryTestFiles.jquery_1_4_1_vsdoc;
                ...
                new { Parameters = new [] { 
                        new { Name = ""a"", Type = ""Function"", Description = ""this is a function param"", Optional = False, FunctionParamSignature = 
                            new { Description = ""func param signature 2"", Parameters = new [] { 
                                ...
                                new { Description = ""func param - return description"" }, CompatibleWith = new [] { }
                            }
                        }
                    }, CompatibleWith = new [] { }
                }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""implicit signature"", Parameters = new [] { 
                    ...
                    new { Type = ""String"", Description = ""return description"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""signature 1"", Parameters = new [] { 
                    ...
                    new { Type = ""String"", Description = ""return description 1"" }, CompatibleWith = new [] { }
                }, 
                new { Description = ""signature 2"", Parameters = new [] { 
                    ...
                    new { Type = ""String"", Description = ""return description 2"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""missingType"", Signatures = new [] { 
                new { Description = ""signature 1"", Parameters = new [] { 
                    ...
                    new { Description = ""return description 1"" }, CompatibleWith = new [] { }
                }, 
                new { Description = ""signature 2"", Parameters = new [] { 
                        new { Name = ""a2"", Description = ""parameter 1"", Optional = False }, 
                        new { Name = ""b2"", Description = ""parameter 2"", Optional = False }
                    }, ReturnValue = 
                    new { Description = ""return description 2"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""missingReturnDescr"", Signatures = new [] { 
                new { Parameters = new [] { 
                    ...
                    new { Type = ""Number"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""summary text "", Parameters = new [] { 
                    ...
                    new { Description = ""return  description"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = @""summary text:<doccomment>content inside an unknown element<para>with a paragraph</para> and some more <d><e><f>unknown</f></e></d></doccomment>tags"", Parameters = new [] { 
                    ...
                    new { Description = @""<AnotherTag name=\""value\""/>return description"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
...
function intCallTest() {
    ...
    new { ParameterIndex = 0, Region = 
        ...
        public void Bug160093()
        {
            ...
            var jquery = JQueryTestFiles.jquery_1_2_6_vsdoc;
            PerformRequests(@"
                function MakeSudoku() {
                ...
                new { Parameters = new [] { 
                        new { Name = ""a"", Type = ""Function"", Description = ""this is a function param"", Locid = ""paramSummaryLocid"", ElementType = ""Empty"", Optional = True, FunctionParamSignature = 
                            new { Description = ""func param signature 2"", Locid = ""signatureSummaryLocid"", ExternalFile = ""signatureExternalFile"", Externalid = ""signatureExternalid"", HelpKeyword = ""signatureHelpKeyword"", Parameters = new [] { 
                                ...
                                new { Type = ""HTMLElement"", Description = ""func param - return description"", Locid = ""returnLocid"", ElementType = ""ReturnType"", HelpKeyword = ""returnHelpKeyword"", ExternalFile = ""returnsExternalFile"", Externalid = ""returnsExternalid"" }, CompatibleWith = new [] { }
                            }
                        }
                    }, CompatibleWith = new [] { }
                }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""implicit signature"", Locid = ""summaryLocid"", Parameters = new [] { 
                    ...
                    new { Type = ""String"", Description = ""return description"", Locid = ""ReturnLocid"", HelpKeyword = ""ReturnHelpKeyword"", ExternalFile = ""returnsExternalFile"", Externalid = ""returnsExternalid"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""get_value"", Signatures = new [] { 
                new { Description = @""<x doubleQuotes=\""&quot;\"" doubleQuotesEscaped=\""&quot;\"" singleQuotes=\""&apos;\"" singleQuotesEscaped=\""&apos;\"" greaterThanEscaped=\""&gt;\"" lessThanEscaped=\""&lt;\"" mixedText=\""text with --&quot;--, --&apos;--, --&amp;--, --&gt;-- and --&lt;--\""/>"", Parameters = new [] { }, ReturnValue = 
                    new { Description = ""text with unescaped characters:  --&apos;--, --&quot;-- ; and escaped characters: --&quot;--, --&apos;--, --&amp;--, --&gt;-- and --&lt;--"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""get_value"", Signatures = new [] { 
                new { Description = ""value Description"", Locid = ""valueLocid"", HelpKeyword = ""valueHelpKeyword"", Parameters = new [] { }, ReturnValue = 
                    new { Type = ""ValueType"", ElementType = ""HTMLElement"" }, CompatibleWith = new [] { }
                }
            }
        }
    }, 
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""Value Description"", Locid = ""valueLocid"", Parameters = new [] { 
                    ...
                    new { Type = ""ValueType"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""implicit signature"", Parameters = new [] { 
                    ...
                    new { Type = ""Array"", Description = ""return description"", ElementType = ""HTMLElement"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""implicit signature"", Parameters = new [] { 
                    ...
                    new { Type = ""deprecate"", Message = ""deprecated message"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
    ...
    new { ParameterIndex = 0, Region = 
        ...
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""explicit signature"", Parameters = new [] { 
                    ...
                    new { Type = ""String"", Description = ""return description"" }, Deprecated = 
                    new { Type = ""remove"", Message = ""deprecated message"" }, CompatibleWith = new [] { }
                }
            }
        }
    }
        ...
        public void CompatibleWithImplicitSignature()
        {
            VerifyFunctionDocComments(CompatibleWithImplicitSignatureFile, CompatibleWithImplicitSignatureExpected);
        }
        #region Test data
        const string CompatibleWithImplicitSignatureFile = @"
function ImplicitSignature() {
    function func(a, b) {
        /// <summary>implicit signature</summary>
        /// <param name=""a"" type=""String"">parameter a</param>
        ...
        /// <compatibleWith platform=""WindowsPhoneAppx"" minVersion=""8.0.42.1"" />
    }
    func(|);
}";
        const string CompatibleWithImplicitSignatureExpected = @"new [] { 
    new { ParameterIndex = 0, Region = 
        new { Offset = 464, Length = 6 }, FunctionHelp = 
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""implicit signature"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""String"", Description = ""parameter a"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""parameter b"", Optional = False }
                    ...
                    new { Type = ""String"", Description = ""return description"" }, CompatibleWith = new [] { 
                        new { Platform = ""Windows"", MinVersion = ""8.1"" }, 
                        new { Platform = ""WindowsPhoneAppx"", MinVersion = ""8.0.42.1"" }
                    }
                }
            }
        }
        ...
        [TestMethod]
        [TestCategory("CompatibleWith")]
        public void CompatibleWithExplicitSingleSignature()
        {
            VerifyFunctionDocComments(CompatibleWithExplicitSingleSignatureFile, CompatibleWithExplicitSingleSignatureExpected);
        }
        #region Test data
        const string CompatibleWithExplicitSingleSignatureFile = @"
function ExplicitSingleSignatureSameAsDecl() {
    function func(a, b) {
        /// <signature>
        ///     <summary>explicit signature</summary>
    ...
    func(|);
        ...
        const string CompatibleWithExplicitSingleSignatureExpected = @"new [] { 
    new { ParameterIndex = 0, Region = 
        new { Offset = 555, Length = 6 }, FunctionHelp = 
        new { FunctionName = ""func"", Signatures = new [] { 
                new { Description = ""explicit signature"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""String"", Description = ""parameter a"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""parameter b"", Optional = False }
        ...
        public void ClassMethodHelp()
        {
            VerifyFunctionDocComments(ClassMethodHelpFile, ClassMethodHelpExpected);
        }
        #region Test Data
        const string ClassMethodHelpFile = @"
class A {
    constructor(a,b) {
        /// <summary>constructor signature (implicit)</summary>
        /// <param name=""a"" type=""Function"">parameter a</param>
        /// <param name=""b"" type=""Array"">parameter b</param>
    }
    method(a,b) {
        /// <signature>
        ///     <summary>method signature #1 (explicit)</summary>
        ///     <param name=""a"" type=""String"">string param</param>
        ///     <param name=""b"" type=""Number"" optional=""true"">number param</param>
        ///     <returns type=""String"">return string</returns>
        /// </signature>
        /// <signature>
        ///     <summary>method signature #2 (explicit)</summary>
        ///     <param name=""a"" type=""Number"">first number</param>
        ///     <param name=""b"" type=""Number"">second number</param>
        ///     <returns type=""Number"">return result</returns>
        /// </signature>
    }
    static staticMethod(a,b) {
        /// <signature>
        ///     <summary>static method signature (explicit)</summary>
        ///     <param name=""a"" type=""Date"">time stamp</param>
        ///     <param name=""b"" type=""String"">message</param>
        ///     <deprecated type=""remove"">deprecated message</deprecated>
        /// </signature>
    }
}
...
A.staticMethod(|);
";
        const string ClassMethodHelpExpected = @"new [] { 
    new { ParameterIndex = 0, Region = 
        new { Offset = 1291, Length = 7 }, FunctionHelp = 
        new { FunctionName = ""A"", Signatures = new [] { 
                new { Description = ""constructor signature (implicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Function"", Description = ""parameter a"", Optional = False }, 
                        new { Name = ""b"", Type = ""Array"", Description = ""parameter b"", Optional = False }
                    }, CompatibleWith = new [] { }
                }
            }
        }
    ...
    new { ParameterIndex = 0, Region = 
        new { Offset = 1303, Length = 8 }, FunctionHelp = 
        new { FunctionName = ""method"", Signatures = new [] { 
                new { Description = ""method signature #1 (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""String"", Description = ""string param"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""number param"", Optional = True }
                    }, ReturnValue = 
                    new { Type = ""String"", Description = ""return string"" }, CompatibleWith = new [] { }
                }, 
                new { Description = ""method signature #2 (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Number"", Description = ""first number"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""second number"", Optional = False }
                    }, ReturnValue = 
                    new { Type = ""Number"", Description = ""return result"" }, CompatibleWith = new [] { }
                }
            }
        }
    }, 
    new { ParameterIndex = 0, Region = 
        new { Offset = 1316, Length = 14 }, FunctionHelp = 
        new { FunctionName = ""staticMethod"", Signatures = new [] { 
                new { Description = ""static method signature (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Date"", Description = ""time stamp"", Optional = False }, 
                        new { Name = ""b"", Type = ""String"", Description = ""message"", Optional = False }
                    }, Deprecated = 
                    new { Type = ""remove"", Message = ""deprecated message"" }, CompatibleWith = new [] { }
                }
            }
        ...
        public void SuperMethodHelp()
        {
            VerifyFunctionDocComments(SuperMethodHelpFile, SuperMethodHelpExpected);
        }
        #region Test Data
        const string SuperMethodHelpFile = @"
class A {
    constructor(a,b) {
        /// <summary>constructor signature (implicit)</summary>
        /// <param name=""a"" type=""Function"">parameter a</param>
...
";
        const string SuperMethodHelpExpected = @"new [] { 
    new { ParameterIndex = 0, Region = 
        new { Offset = 1333, Length = 7 }, FunctionHelp = 
        new { FunctionName = ""A"", Signatures = new [] { 
                new { Description = ""constructor signature (implicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Function"", Description = ""parameter a"", Optional = False }, 
                        new { Name = ""b"", Type = ""Array"", Description = ""parameter b"", Optional = False }
    ...
    new { ParameterIndex = 0, Region = 
        new { Offset = 1374, Length = 7 }, FunctionHelp = 
        new { FunctionName = ""A.prototype.method"", Signatures = new [] { 
                new { Description = ""method signature #1 (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""String"", Description = ""string param"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""number param"", Optional = True }
                    }, ReturnValue = 
    ...
    new { ParameterIndex = 0, Region = 
        new { Offset = 1398, Length = 8 }, FunctionHelp = 
        new { FunctionName = ""method"", Signatures = new [] { 
                new { Description = ""method signature #1 (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""String"", Description = ""string param"", Optional = False }, 
                        new { Name = ""b"", Type = ""Number"", Description = ""number param"", Optional = True }
    ...
    new { ParameterIndex = 0, Region = 
        new { Offset = 1453, Length = 7 }, FunctionHelp = 
        new { FunctionName = ""A.staticMethod"", Signatures = new [] { 
                new { Description = ""static method signature (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Date"", Description = ""time stamp"", Optional = False }, 
                        new { Name = ""b"", Type = ""String"", Description = ""message"", Optional = False }
                    }, Deprecated = 
    ...
    new { ParameterIndex = 0, Region = 
        new { Offset = 1477, Length = 14 }, FunctionHelp = 
        new { FunctionName = ""staticMethod"", Signatures = new [] { 
                new { Description = ""static method signature (explicit)"", Parameters = new [] { 
                        new { Name = ""a"", Type = ""Date"", Description = ""time stamp"", Optional = False }, 
                        new { Name = ""b"", Type = ""String"", Description = ""message"", Optional = False }
