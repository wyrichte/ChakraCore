...
(function () {
    ...
    intellisense.addEventListener('statementcompletion', function (context, completions) {
...
//        if (logInfos) logInfo("Context.target is " + context.target);
    ...
    intellisense.addEventListener('signaturehelp', function (context, functionHelp) {
            ...
            if (context.parentObject) {
                ...
                if (getterFunction) {
                    if (context.getComments) {
                        ...
                        if(intellisense["MicrosoftAjaxLogLevelError"]) logError("UNEXPECTED: No getComments exist on the current context.");
                    }
                }
                else {
