...
namespace DirectAuthorTests
{
    ...
    {
        protected static readonly string MicrosoftAjaxFilePath = Path.Combine(Paths.FilesPath, "MicrosoftAjax.js");
        protected static readonly string MicrosoftAjaxWebFormsFilePath = Path.Combine(Paths.FilesPath, "MicrosoftAjaxWebForms.debug.js");
        ...
        public void MSAjaxCompletion()
        {
            ...
            var msajaxFile = _session.ReadFile(MicrosoftAjaxFilePath);
            var msajaxWebFormsFile = _session.ReadFile(MicrosoftAjaxWebFormsFilePath);
        ...
        public void SourceFileHandle()
        {
            PerformRequests(@"Function.|", (context, offset, data, index) =>
                ...
                false, 
                Paths.DomWebPath, 
                Path.Combine(Paths.FilesPath, @"MicrosoftAjax.js"), 
                Path.Combine(Paths.FilesPath, @"MicrosoftAjax.intellisense.js")
            );
