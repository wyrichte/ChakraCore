...
namespace DirectAuthorTests
{
    ...
    public class CompletionHintTests : DirectAuthorTest
    {
        ...
        public void PrototypeFieldDocComments()
        {
            ...
            var msajax = _session.ReadFile(Path.Combine(Paths.FilesPath, @"MicrosoftAjax.js")).Text;
        ...
        [TestMethod]
        [WorkItem(192364)]
        public void BegginningOfScopeWithDirectExecution()
        {
        ...
        private void TestCompletionHint(string script, string completionDisplayName, Action<IAuthorSymbolHelp> validate, params string[] contextFiles)
        {
        ...
        void PerformCompletionRequests(string text, Action<IAuthorCompletionSet, string, int> action, params string[] contextFiles)
        {
