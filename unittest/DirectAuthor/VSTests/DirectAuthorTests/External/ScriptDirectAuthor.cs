...
namespace Microsoft.VisualStudio.JavaScript.LanguageService.Engine
{
    public static class AuthorConstants
    {
        ...
        internal const string ErrorIdentifier = "?";
    }
    ...
    // Represents the various supported ECMA script versions.
    public enum AuthorECMAVersion
    {
        ECMAScript5,
        ECMAScript6
    }
    ...
    public interface IAuthorFileReader
    {
        ...
        // Seeks the the specified offset. The offset is specified in code points.
    ...
    public interface IAuthorReferenceSet
    {
        ...
        void GetItems(int startIndex, int count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), Out] AuthorSymbolReference[] messages);
    }
    ...
    public interface IAuthorFileHandle
    {
        ...
        // A unique long for the file handle that is unique for every IAuthorFileHandle instance.
        int FileId { get; }
    }
    ...
    public enum AuthorHostType
    {
        ...
        // Currently this implies legacy-free language features, use it for WWA.
        ahtApplication
    };
    ...
    public interface IAuthorFileContext
    {
        ...
        // If insertBeforeSoruceFile is set to true, the requested script needs to be loaded for the source file to execute correctly
        ...
        AuthorFileAsynchronousScriptStatus VerifyScriptInContext(
                ...
                [MarshalAs(UnmanagedType.VariantBool)] bool insertBeforeSoruceFile);

        // Retreive the target ECMA version for this set of files.
        AuthorECMAVersion GetECMAVersion();
    }
    ...
    public enum AuthorDiagStatus
    {
        ...
        // An internal parser error occurred while parsing function XML doc comments.
    ...
    public interface IAuthorCompletionSet
    {
        ...
        // Retreive the hint for the given completion in the list.
        IAuthorSymbolHelp GetHintFor(int index);

        // Retreive the set kind
    ...
    public enum AuthorParseNodeProperty
    {
        ...
        // Starting offset of the identifier name of a function or a var decl
        apnpIdentifierMin,
    ...
    public interface IAuthorParseNodeCursor
    {
        ...
        // serialized.
        IAuthorParseNodeSet GetSubTree(int depth = -1);
        ...
        // show them (e.g. statement span of if statmetn is the if keyword and the condition, similarlly that of a do while loop is
    ...
    public enum AuthorStructureNodeKind: uint
    {
        ...
        // The node contains an additional region for the container
        asnkRegion,
    ...
    public struct AuthorStructureNode
    {
        ...
        // This is true if a node, in the full set of nodes, has this node as a contain.
    ...
    public interface IAuthorStructureNodeSet
    {
        ...
        // Retrieves count completions starting at startIndex.
        void GetItems(int startIndex, int count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), Out] AuthorStructureNode[] completions);
    }
    ...
    // and the tree is formed by "container" edge, children point to their containers. Each call will produce a IA
    ...
    public interface IAuthorStructure
    {
        ...
        // They key parameter must be a value returned as a set from same instance of IAuthorStructure.
    ...
    public interface IAuthorServices
    {
        ...
        // Invoke the engine's internal cleanup routine. This forces GC to kick in and collect any unused objects resulting
    ...
    public interface IAuthorAllocInfo
    {
        ...
        string Category { [return: MarshalAs(UnmanagedType.BStr)] get; }
    }
    ...
    public interface IAuthorAllocInfoSet
    {
        ...
        // Return AuthorAllocInfo items.
        void GetItems(int startIndex, int count, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1), Out] IAuthorAllocInfo[] items);
    }
    ...
    public interface IAuthorDiagnostics
    {
        ...
        IAuthorAllocInfoSet GetAllocStats();
