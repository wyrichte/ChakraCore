function asmModule(stdlib, imports) {
    ...
    function func2()
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            globImportF4 = f4(15534.3, b.w * b.z, fround(5034.12)+fround(344.0), fround(globImportD2.y));
    ...
    function func3()
    {
        ...
        do {
            ...
            f4g1 = f4(0.0, b.y, fround(i4g1.x) + fround(i4g1.y), fround(gval2));
            f4g1 = f4add(f4g1, b);
