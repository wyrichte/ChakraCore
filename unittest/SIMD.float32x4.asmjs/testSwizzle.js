function asmModule(stdlib, imports) {
	...
	function swizzle1()
    {
		...
		x = +sqrt((+xyxy.x * +xyxy.x) + (+xyxy.y* +xyxy.y) + (+xyxy.z * +xyxy.z) + (+xyxy.w * +xyxy.w));
		y = +sqrt((+zwzw.x * +zwzw.x) + (+zwzw.y* +zwzw.y) + (+zwzw.z * +zwzw.z) + (+zwzw.w * +zwzw.w));
		z = +sqrt((+xxxx.x * +xxxx.x) + (+xxxx.y* +xxxx.y) + (+xxxx.z * +xxxx.z) + (+xxxx.w * +xxxx.w));
		w = +sqrt((+xxyy.x * +xxyy.x) + (+xxyy.y* +xxyy.y) + (+xxyy.z * +xxyy.z) + (+xxyy.w * +xxyy.w));		
