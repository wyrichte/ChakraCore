...
var i4 = stdlib.SIMD.int32x4;
    ...
    function func1(a)
    {
        ...
        while ( (loopIndex|0) < (loopCOUNT|0)) {
            ...
            b = f4(b.w * b.z, b.z / b.y, b.y + b.x, -b.x);
            //b = f4(b.w, b.z, b.y, b.x);
    ...
    function func2(a)
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            b = f4( f4g1.w * b.z, f4g2.z / b.z, -f4g1.y, f4g2.x + fround(1.0) );
    ...
    function func3(a)
    {
        ...
        do {
            ...
            globImportF4 = f4(globImportF4.x + fround(2.0), fround(4.0) * globImportF4.y, fround(1.0) / f4g2.z, f4g2.w * fround(2.0));
