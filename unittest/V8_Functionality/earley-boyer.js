...
var earley = function() { BgL_earleyzd2benchmarkzd2(); };
var boyer = function() { BgL_nboyerzd2benchmarkzd2(); }

var start = new Date();
earley();
var elapsed = new Date() - start;
//WScript.Echo("EarleyBoyer - Earley(): " + elapsed + 'ms');

start = new Date();
boyer();
elapsed = new Date() - start;
//WScript.Echo("EarleyBoyer - Boyer(): " + elapsed + 'ms');