...
try{eval("/*for..in*/for(var this = 3.141592653589793 in x)  /x/g ;");}catch(ex){}
try{eval("/*for..in*/for(var   = \nwindow in 0.1) throw undefined;");}catch(ex){}
...
try{eval("(x2);");}catch(ex){}
try{eval("/*for..in*/L:for(var null in ((null)(x = (function ([y]) { })()))){break L;var x; }");}catch(ex){}
...
try{eval("/*for..in*/for(var y = [15,16,17,18].filter(Math.pow, window) in 033) {var x5 = [], y = 4.; }");}catch(ex){}
try{eval("{(\u3056);( \"\" ); }");}catch(ex){}
try{eval("/*for..in*/for(var [x, x] = new [1,2,3,4].slice(this.eval(true), x.propertyIsEnumerable(\"x\")) in x.yoyo( /x/ ) % undefined( /x/g )) {var x; \"\" ; }");}catch(ex){}
...
try{eval("M:if((({x2: window(function ([y]) { }) = [ /x/g ]}))) {throw undefined/*for..in*/for(var  /x/g  !== false.isPrototypeOf(x4 = ({})) in NaN.valueOf(\"number\")) {var get =  /x/ , x; } } else  if ([15,16,17,18].filter((this , 1e4).apply, x =  /x/ )) M:if(x) { if ([z1,,]) {var \u3056; }} else {}");}catch(ex){}
try{eval("{}");}catch(ex){}
try{eval("var window, x = true;");}catch(ex){}
try{eval("if(/*\n*/((([11,12,13,14].filter).x)(false & window.propertyIsEnumerable(\"x\"), (x4)(undefined, 033)))) {/*for..in*/for(var y in undefined) {return .2; } } else  if ((new this(<xxx {y}={<x><y/></x>.( \"\" )} />.(window.(x1-=x)))))  \"\" ");}catch(ex){}
try{eval("({}).hasOwnProperty");}catch(ex){}
...
try{eval("/*for..in*/for(var x2 = \nnew ((NaN.prop = (x = [z1])))() in this) M:while((delete x5) && 0){var \u3056 = true, this;[1,2,3,4].map }");}catch(ex){}
try{eval("do /*for..in*/M:for(var x3 in window) {function () { (functional); } throw [1,,]; } while(((1e-81.watch(\"x1\", 'haha'.split))) && 0);");}catch(ex){}
try{eval("  = x5;");}catch(ex){}
try{eval("for(let y in []);");}catch(ex){}
try{eval("L: {/*for..in*/for(var [x, x1] = .2 in this) {throw this; } }");}catch(ex){}
...
try{eval("/*for..in*/for(var window in ((eval)(({a2:z2}))))var /*\n*/x = -3/0;");}catch(ex){}
...
try{eval("/*for..in*/for(var x in [[1]]) CollectGarbage()");}catch(ex){}
try{eval("/*for..in*/M:for(var \u000c; in ((({}).hasOwnProperty)((this = -3/0))))switch(this) { default: break; ( /x/ );var x5 = window, x5;break; case 1: case 3: var x;break; (undefined); }\nreturn function ([y]) { };\n");}catch(ex){}
try{eval("var x;");}catch(ex){}
try{eval("/*for..in*/L:for(var NaN =  \"\"  in \u3056) CollectGarbage()");}catch(ex){}
...
try{eval("/*for..in*/for(var y = x2 in window\u000c) {return this; }\u000c");}catch(ex){}
try{eval("([[]]);");}catch(ex){}
try{eval("return;");}catch(ex){}
try{eval("{ }");}catch(ex){}
try{eval("{return; }");}catch(ex){}
try{eval(" { yield this } ");}catch(ex){}
try{eval("M:if(({x:  \"\"  }) -= prop / true.prototype = x1.x4.isPrototypeOf(false !== 1e81.watch(\"x\", function  x () { yield  /x/  } ))) if(this) {throw [z1,,];x5 }");}catch(ex){}
...
try{eval("/*for..in*/L:for(var \u3056 in ({a1:1})) /*for..in*/for(var NaN in (( /x/g )([[1]])))throw undefined;");}catch(ex){}
...
try{eval("if(--) { if (({x setter: /a/gi }).\u3056) throw StopIteration; else {{/*for..in*/for(var x in null) {[z1,,];continue M; } }; }}");}catch(ex){}
...
try{eval("\n");}catch(ex){}
try{eval("if((null in 3.141592653589793) = (x = 1e+81).hasOwnProperty(\"window\")) { if (x5 = this) {var \u3056 = 5.0000000000000000000000;/*for..in*/for(var x in ((function  x (y,  ) { var x; } )(this))); }} else {CollectGarbage() }");}catch(ex){}
try{eval("/*for..in*/M:for(var [, x4, , ] in ((eval)((+y))))if(1e-81) { if (true) {return  '' ; }} else { }");}catch(ex){}
...
try{eval("(3.141592653589793);");}catch(ex){}
...
try{eval("\n");}catch(ex){}
try{eval("var x, x\n/*for..in*/for(var ([z1,,])( /x/g ) in y) {return;return x; }");}catch(ex){}
try{eval("x = x;");}catch(ex){}
try{eval("L:if(new Function((x.prototype = (({ x2: window, x2: x }) = (.2 ^ this))))) { if ((this :: --this = (prototype.prop))) {break L;/*for..in*/for(var x = (true ? x : window) in [z1]) {false; } } else CollectGarbage()}");}catch(ex){}
...
try{eval("CollectGarbage()");}catch(ex){}
try{eval("/*for..in*/for(var [ , x5] = eval(\"return [1,,];\", 033) in (null | [1,,] < (({functional getter: function (x, x) /x/g  })))) {return 'fafafa'.replace(/a/g,  /x/g );throw \u3056; }");}catch(ex){}
try{eval("/*for..in*/for(var x in (([1,2,3,4].map)(undefined ? null : function::\u3056(function(id) { return id }\n)))){L: var x1, x = 3/0; }");}catch(ex){}
try{eval("/*for..in*/for(var [this, x] = window in ((p={}, (p.z =  '' )())) :: ((this for each (x in [[1]])))) CollectGarbage()");}catch(ex){}
...
WScript.Echo("200");
try{eval("/*for..in*/for(var x in ((function () { return  '' .hasOwnProperty(\"x4\").x1 } )(('fafafa'.replace(/a/g, Math.sin)))))M:if(({a2:z2}). ) { } else return -0;\u000c");}catch(ex){}
...
try{eval("/*for..in*/for(var [y, functional] = x in this) CollectGarbage()");}catch(ex){}
...
try{eval("if(null.watch(\"y\", this)) { if (3) return;} else {var x2; }");}catch(ex){}
...
try{eval("/*for..in*/L:for(var x = (false)[ /* Comment */function ([y]) { }] in false[() = ([z1].watch(\"x\", function(q) { return q; }))]) {var x, x;return (-0); }");}catch(ex){}
...
try{eval("throw StopIteration;");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) for(let y in [5,6,7,8]) return;/*for..in*/L:for(var (x1 =  '' )((true / 1e81)) in ((new Function)( /* Comment */null)))var x5;");}catch(ex){}
try{eval("L:with({x: 1.2e3}){{}CollectGarbage() }");}catch(ex){}
try{eval(";\nreturn;\n");}catch(ex){}
try{eval("/*for..in*/M:for(var x = x in []) return;");}catch(ex){}
...
try{eval("/*for..in*/for(var [x,  ] =  /* Comment */(this.zzz.zzz) in {}) {continue M;function (x) { yield  /x/g  }  }");}catch(ex){}
try{eval("try { continue M; } finally { CollectGarbage() } ");}catch(ex){}
try{eval("eval");}catch(ex){}
...
try{eval("for(let y in []);");}catch(ex){}
try{eval("Math.pow\n");}catch(ex){}
try{eval("/*for..in*/for(var [x, NaN] =  for (x in NaN) for each (x in x) in 3/0) {return  /x/g ; }");}catch(ex){}
try{eval("if(this) { if (function  x ( /x/g ) { yield [1] } ) {evalvar x, x; } else {(window); }}");}catch(ex){}
try{eval("with((-0));");}catch(ex){}
try{eval("for(let y in []);");}catch(ex){}
try{eval("/*for..in*/for(var window = var x3 = false;.watch(\"x4\", function(q) { return q; }) in (+true)) {continue L;var y = window, x =  '' ; }");}catch(ex){}
try{eval("if((new Exception())) { if (( /x/g  -= [[1]])) var , functional; else throw window;}");}catch(ex){}
try{eval("/*for..in*/for(var [y, x3] =  ''  in this) break L;");}catch(ex){}
...
try{eval("/*for..in*/L:for(var [window, x3] = \n' in [1]) this;");}catch(ex){}
try{eval("if(( /x/ )(this) || (uneval(1.2e3))) { if ((function  x ()false)) {(window).watch; }} else {{} }");}catch(ex){}
try{eval("this;\nbreak L;\n");}catch(ex){}
try{eval("/*for..in*/L:for(var [this, this] = ({}-- ? delete 4. : x = false) in  /x/g ) \nvar x;");}catch(ex){}
...
try{eval("/*for..in*/for(var [x, x] =  \"\"  in 5.0000000000000000000000) ( );");}catch(ex){}
try{eval("(true);\nthrow window;\n\n");}catch(ex){}
try{eval("return;");}catch(ex){}
try{eval("/*for..in*/for(var x1 =  '' .valueOf(\"number\") *= (this).eval(([4. if (this)])) in x4 = null\n) L:do var x4, x;/*\n*/ while((null in undefined) && 0);");}catch(ex){}
try{eval("while(([x4]) && 0)return 1e+81;");}catch(ex){}
try{eval("return  /x/g ;");}catch(ex){}
try{eval("/*for..in*/M:for(var x in ((({}).hasOwnProperty)(null >> this)))return x = window;");}catch(ex){}
...
try{eval("/*for..in*/M:for(var window = undefined in  /x/g ) break M;");}catch(ex){}
...
try{eval("/*for..in*/L:for(var x1 in (((Math.sin).call)(window)))switch(([11,12,13,14].filter)) { default: break; break;  }");}catch(ex){}
try{eval("for(let y in []);");}catch(ex){}
try{eval("/*for..in*/for(var   get x x (x) { return; } NaN in try {  } finally { ( '' ); } ) break M;");}catch(ex){}
try{eval("L: {(({a1:1})); }");}catch(ex){}
try{eval("M:\u0009if() { if ( '' .window) {} else [,];}");}catch(ex){}
try{eval("/*for..in*/for(var x3(x) in  /x/ ) throw x1;\n{var x1 = undefined, x;(x2).watch }\n");}catch(ex){}
...
try{eval("/*for..in*/for(var x2 in (1e-81 *= window) -= [z1,,]) x = x;");}catch(ex){}
...
try{eval(";return");}catch(ex){}
try{eval("/*for..in*/for(var x3 = (x)[(-0)] in window) \nif(0x99) {var [,] = 0.1, y; } else  if ((function ([y]) { })()) \n");}catch(ex){}
...
try{eval("return;");}catch(ex){}
try{eval("CollectGarbage()if(function (prototype) \"\" ()) \u0009{CollectGarbage/*for..in*/for(var x in (\u000c(function  x4 (x4) { var getter = 1e81, x = x; } )([]))){return true; } } else  if ((-1)) ;");}catch(ex){}
...
try{eval("/*for..in*/for(var x in (([1,2,3,4].slice)( '' )))( /x/ );");}catch(ex){}
try{eval("NaN = x1;");}catch(ex){}
try{eval("/*for..in*/for(var (new let (x = 3.141592653589793, x) -0(window))( /* Comment */new eval([,,z1], this) = 3 > window.unwatch(\"window\")) in (( /x/ )((this.unwatch(\"this\") :: ({ get x3(x) { return 1.3 }  })))))var y\ncontinue M;");}catch(ex){}
try{eval("/*for..in*/for(var y in (('haha'.split)(x\n))){M:if(undefined)  \"\" ; else {var x;; } }");}catch(ex){}
try{eval("");}catch(ex){}
try{eval("/*for..in*/for(var x1 in 033) var x, x =  \"\" ;\ncontinue M;\n");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) return  \"\" ;");}catch(ex){}
...
try{eval("/*for..in*/for(var (true.propertyIsEnumerable(\"window\") - --this)(x3 = 1e-81) in (1e4 >= x)) this");}catch(ex){}
try{eval("return NaN;");}catch(ex){}
try{eval("if(({a2:z2})--) { if () {var \u000c\u3056 = x5;CollectGarbage() } else Function}");}catch(ex){}
try{eval("/*for..in*/for(var [x5, functional] = this = function(id) { return id } in false) var x2, x;");}catch(ex){}
...
try{eval("if((eval(\"x\", function(id) { return id }))) {(-1);/*for..in*/L:for(var x5 in ((function  window (window) { return; } )(3.141592653589793))){} }");}catch(ex){}
...
try{eval("/*for..in*/for(var [x,  { yield (this.zzz.zzz) } ] = [,,] in (x2 =   :: window)) try { throw window; } finally { with({}) {} } ");}catch(ex){}
try{eval("/*for..in*/for(var window = (Iterator()) in 5.0000000000000000000000) var x;");}catch(ex){}
try{eval("throw StopIteration;");}catch(ex){}
...
try{eval("for(let y in []);");}catch(ex){}
try{eval("/*for..in*/L:for(var x((function (this, x)NaN)()) in ((eval)((({a1:1}).valueOf(\"number\")))))L:if(window.propertyIsEnumerable(\"x\")) var x5 = [], this = 0.1; else var x4 = x;");}catch(ex){}
...
try{eval("if((({ set x x (x, this) { return window } , functional setter: function  x (x, x) { function  x () { return true; }  }  }))) { if ((function ([y]) { })()) {var this, x = true;var x3, x = x; }} else {/*for..in*/for(var x =  in  /x/ ) var this, y =  /x/g ; }");}catch(ex){}
try{eval("while((true) && 0)CollectGarbage()");}catch(ex){}
try{eval("L: { }");}catch(ex){}
try{eval("this = y;");}catch(ex){}
try{eval("{var get = -0;/*for..in*/for(var x = ( /x/g  .@x:: 1.3) in this) CollectGarbage() }");}catch(ex){}
...
try{eval("/*for..in*/for(var x = (true.throw( /x/ ))-- in 'fafafa'.replace(/a/g, (-1))) {throw x; }");}catch(ex){}
...
try{eval("/*for..in*/for(var x in ((Math.pow)(({functional: this}))))break L;\nfunction  x (x)0.1\n");}catch(ex){}
try{eval("(x4)\n{{}Function }");}catch(ex){}
...
try{eval("/*for..in*/for(var x in window) {continue M;return ({a2:z2}); }\n");}catch(ex){}
try{eval("/*for..in*/for(var x = (1e81 < x1 ? x.prototype = new (( /x/g  ^= []))(new ({})(), false) : new Error( , 3).propertyIsEnumerable(\"functional\") >>> (x4--)) in (((y)%=y << window).isPrototypeOf(x - x3--))) throw [[1]];\nthrow  '' ;/*\n*/\n");}catch(ex){}
try{eval("x = functional;");}catch(ex){}
try{eval("switch((window &= undefined)()) { case x((function ([y]) { })()): {(undefined); }case new [1]: {} }");}catch(ex){}
try{eval("/*for..in*/for(var function::x in x1 = [z1]) {Math.sin }");}catch(ex){}
try{eval("return functional.((null.eval(function ([y]) { })));");}catch(ex){}
try{eval("{throw undefined; }");}catch(ex){}
try{eval("/*for..in*/for(var [x, x] = (x = <xxx>{x3}</xxx>) in new  /x/g ([,])) {return this; }");}catch(ex){}
try{eval("/*for..in*/for(var x = true in [function::x2 .. undefined].some(false)) {L:while(([undefined].eval( .(1.2e3))) && 0){L:if(false) { if ([,,z1]) ; else return;}while(( /x/ ) && 0){x5; } } }");}catch(ex){}
...
try{eval("this.zzz.zzz;");}catch(ex){}
try{eval("/*for..in*/for(var window in [z1,,]) {[1,2,3,4].map }");}catch(ex){}
try{eval("\u0009if(([11,12,13,14].map)) { if (({ \u3056: ({ x: x, y: x }) }) = function ([y]) { } | 3/0) {return  /x/g ;/*for..in*/for(var x in window) {continue L; } }} else {\u000dwith({x:  /x/g }){return false; } }");}catch(ex){}
...
try{eval("\nreturn null;\n");}catch(ex){}
try{eval("/*for..in*/for(var this in x5) return;");}catch(ex){}
...
try{eval("throw x;");}catch(ex){}
try{eval("/*for..in*/for(var [NaN, \u3056] = this in x) {(NaN);\u000c }");}catch(ex){}
...
try{eval("/*for..in*/for(var [y, x] = [(({ get x(x) { yield 033 ? window : functional }  }))]++ in NaN) {with({}) for(let y in [5,6,7,8]) try {  } catch(\u3056 if (function(){undefined;})()) { return this; } catch(x) { window; } finally { return; }  }");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) this.zzz.zzz;");}catch(ex){}
try{eval("Function");}catch(ex){}
try{eval("x =  ;");}catch(ex){}
try{eval("{if(({a1:1})) return functional; else  if (x3) {CollectGarbage() }\nM:while((([].x3)) && 0)true;\n }");}catch(ex){}
try{eval("switch((( /x/ .prototype = null) && ( /x/g )().yoyo(()))) { default: /*for..in*/for(var this in ((function  x4 () { return; } )((undefined |= ({a2:z2}) if (window)))))throw  /x/g ;case 1.3: case 7: break;  }");}catch(ex){}
...
try{eval("L: {return; }");}catch(ex){}
try{eval("if(x.propertyIsEnumerable(\"x\")()) {/*for..in*/for(var NaN = window++ in \n({a2:z2})) {var x = 0x99;{} } }");}catch(ex){}
WScript.Echo("600");
try{eval("do {(null);; } while(((Math.sin).call(null,  /x/ )) && 0);");}catch(ex){}
try{eval("/*for..in*/for(var ((-1))((delete -3/0).valueOf(\"number\")) in ((( /x/g ()).watch)((this.prototype))))return x;");}catch(ex){}
try{eval("return;");}catch(ex){}
try{eval("/*for..in*/M:for(var get([window]) in ((({}).hasOwnProperty)(0x99))){if(window) { if ( /x/g ) {var x, x; }} else {x{} } '' ; }");}catch(ex){}
...
try{eval("{break L;/*for..in*/for(var x in \u3056) {} }");}catch(ex){}
try{eval("continue L;");}catch(ex){}
try{eval("try { for(let y in []); } catch(let) { throw x; } finally { with({}) window = y; } ");}catch(ex){}
try{eval("with({}) /*for..in*/M:for(var [function::\u3056, x] = functional in undefined) {return [1];(window); }");}catch(ex){}
try{eval("{(({a1:1})); }");}catch(ex){}
try{eval("/*for..in*/for(var x1 in ((/a/gi)(this.zzz.zzz))){if(({} + x)) {var this = [,,z1], window;var x; } else  if (typeof [[]]) {([[]]); } else CollectGarbage()var this = this; }");}catch(ex){}
try{eval(";");}catch(ex){}
...
try{eval("if([false]) /*for..in*/for(var x1 in (((/a/gi).call)(NaN = (function ([y]) { })()))){/*for..in*/for(var NaN = x5 in this) CollectGarbage() } else  if ([x3]) ( '' );");}catch(ex){}
try{eval("switch((x)(window, true)) { case [window]: continue L\u000c;break; case 6: default:  }\n/*for..in*/for(var x in 3.141592653589793) ([[1]]);");}catch(ex){}
...
try{eval("if((([1,2,3,4].slice).call)()) /*for..in*/L:for(var x in 1.3) break M; else  if (([11,12,13,14].sort)) M:with({\u3056: ([15,16,17,18].map(window, 1e4).unwatch(\"NaN\"))})var window = 1e+81;");}catch(ex){}
...
try{eval("/*for..in*/for(var [\u3056, x] = (({a2:z2}).watch(\"NaN\", ({}).hasOwnProperty)) in [,,z1].watch(\"y\", function(q) { return q; })) {M:if(null.isPrototypeOf(function::\u3056)) { if (x) {(undefined);CollectGarbage() }} else {var x1, x5 = this;var prototype; } }");}catch(ex){}
try{eval("{;var x = ({a1:1}), x3 = 1.2e3; }");}catch(ex){}
try{eval("{{var x2 = 4.;Math.pow } }");}catch(ex){}
try{eval("if(window++) /*for..in*/for(var [x4, x4] = 0 in false) x else  if (eval(\"/*for..in*/for(var x2 in ((CollectGarbage)(false))){{} }\", null.x3.unwatch(\"x3\"))) (0x99); else return;");}catch(ex){}
try{eval("/*for..in*/for(var x in ((window)(false))){var x3 = [1,,], 5.0000000000000000000000 =  \"\" ;var x = functional; }");}catch(ex){}
try{eval("/*for..in*/for(var ({})\n in (((eval(\"0x99\", -0)))(null = functional))){function ( , x) { {} }  }");}catch(ex){}
try{eval("L: var functional;");}catch(ex){}
try{eval("/*for..in*/L:for(var x3 in ( /x/g .throw(.2))) ;");}catch(ex){}
try{eval("break L;");}catch(ex){}
...
try{eval("with((1e4.x3 && function ([y]) { }.valueOf(\"number\")).prototype)/*for..in*/for(var [\u3056, x] =  /x/  in this) {throw arguments; }");}catch(ex){}
try{eval("/*for..in*/for(var NaN = x2 = x in [1,,]) var x,   = window;");}catch(ex){}
try{eval("if([,,]) { if ( /x/g .prototype =  /x/  *=  /x/  .. x) {{}null } else {var x = 1e4, \u3056;return\n }}");}catch(ex){}
try{eval("");}catch(ex){}
try{eval("(5.0000000000000000000000);");}catch(ex){}
try{eval("switch(x = prototype) { case 1: break;  }");}catch(ex){}
try{eval("throw [1,,]\n");}catch(ex){}
try{eval("/*for..in*/M:for(var x = (\u000c~this) in [1]) {throw true;return 1.2e3; }");}catch(ex){}
try{eval("x4 = x;");}catch(ex){}
...
try{eval("/*for..in*/for(\u0009var x = [-3/0].filter([]) .. x.y in (-1)) {thisreturn 033; }");}catch(ex){}
try{eval("0.1;{}");}catch(ex){}
try{eval("(this)\nreturn;");}catch(ex){}
...
try{eval("L: \u0009return;");}catch(ex){}
try{eval("if((NaN\u0009.prototype = undefined.watch(\"functional\", eval))) { if (this.zzz.zzz) /*for..in*/for(var x in ((((new Function(\"( /x/ );\"))).apply)(false))){return 4.;return; }} else /*for..in*/for(var window = -0 in \u3056) {return;return; }");}catch(ex){}
try{eval("M:if((p={}, (p.z = x = ([ \"\" ]))())) {var x = window, (-0) }");}catch(ex){}
try{eval("L:if() {} else {}break L;");}catch(ex){}
try{eval("[1,2,3,4].slice");}catch(ex){}
...
try{eval("/*for..in*/for(var x in  /x/g ) CollectGarbage()\n{}");}catch(ex){}
try{eval("/*for..in*/for(var window = 4. in this) {function  functional () { var x = x4; }  }");}catch(ex){}
...
try{eval("for(let y in []);");}catch(ex){}
try{eval("with({window: (!3)}){;/*for..in*/for(var (true)(this) in (([true])(( \"\" .isPrototypeOf( '' ))(this,  \"\" ))))with({x1:  /x/ })[1]; }");}catch(ex){}
try{eval("{{/*for..in*/for(var x4 = x =  \"\"  in x) {continue M; } } }");}catch(ex){}
try{eval("/*for..in*/for(var [functional, x4] = (function ([y]) { }++) in (Function(x4)).x) /*for..in*/L:for(var x in ((Math.sin)((window.prop)))){var x3; }");}catch(ex){}
...
try{eval("/*for..in*/for(var [function::functional, x] = this in function ([y]) { }) do  /x/ ; while(( /x/g ) && 0);");}catch(ex){}
try{eval("if(functional = true) {throw false; } else  if (CollectGarbage()) var x;");}catch(ex){}
try{eval("eval");}catch(ex){}
try{eval("([,])\n");}catch(ex){}
try{eval("/*for..in*/for(var [NaN,  ] =  /x/g  in 0x99) var x, NaN;");}catch(ex){}
try{eval("try { CollectGarbage() } finally { var x1, x3 = [1]; } ");}catch(ex){}
try{eval("while(( \"\" ) && 0){return; }");}catch(ex){}
try{eval("/*for..in*/for(var x4 = 0.unwatch(\"x\") in  ) {([1,,]);; }");}catch(ex){}
...
try{eval("L: ([,]);");}catch(ex){}
try{eval("( '' );");}catch(ex){}
try{eval("/*for..in*/for(var [x3, x] = {} in true) {(this); { return; }  }");}catch(ex){}
try{eval("L: x");}catch(ex){}
try{eval("function  window (x3)4./*for..in*/for(var [\u3056, x2] = this in  '' )  yield break M;");}catch(ex){}
...
try{eval("/*for..in*/for(var x = this in NaN) CollectGarbage()");}catch(ex){}
...
try{eval("/*for..in*/L:for(var x5 = new Error(arguments) in [,,z1]) (x1);");}catch(ex){}
...
try{eval("with(x)");}catch(ex){}
try{eval("({}).hasOwnProperty");}catch(ex){}
try{eval("1e+81;");}catch(ex){}
try{eval("/*for..in*/for(var functional in ( \"\" .unwatch(\u0009\"x\"))) return 0;");}catch(ex){}
WScript.Echo("800");
try{eval("({}).throw(this)");}catch(ex){}
...
try{eval("/*for..in*/for(var functional--['\u3056'] in ((/a/gi)([function ([y]) { } if (null)]))){return; }");}catch(ex){}
try{eval("with({x: null})if(x) {;CollectGarbage() } else { }");}catch(ex){}
try{eval("{/*for..in*/for(var [x, x] =  /* Comment */this /=  ''  in false) {CollectGarbage()var NaN = false; }CollectGarbage()\nMath.sin\n }");}catch(ex){}
try{eval("{}\nvar 4.;\n");}catch(ex){}
try{eval("throw function::function:: ;");}catch(ex){}
try{eval("M:if(false{(undefined);x }");}catch(ex){}
try{eval("/*for..in*/for(var [x, x1] = \u3056-=[,] in  /x/g ) {([z1]); }");}catch(ex){}
...
try{eval("/*for..in*/for(var x in ((Math.sin)(({x4 setter: Function, x: ( .(())) }))))if((function ([y]) { })()) { if (true) { }} else {}");}catch(ex){}
...
try{eval("L:do {window;/*for..in*/for(var [x1, NaN] = 3/0.hasOwnProperty(\"x4\").yoyo( \"\" ) in null) var \u3056 = [[]], x = ({a1:1}); } while((-\u3056 = x = window) && 0);");}catch(ex){}
try{eval("L\n:\u000cwith({window: + }){/*for..in*/for(var [x4,  ] = x in -3/0) 'haha'.split }");}catch(ex){}
try{eval("{return; }");}catch(ex){}
try{eval("{while((this) && 0) }");}catch(ex){}
try{eval("var this = x3, x4 = x;");}catch(ex){}
try{eval("L: {}");}catch(ex){}
try{eval("if(x) {/*for..in*/for(var \u3056 = 3/0 in 1e-81) var x4 = true; }\u000c else  if (window) {return  '' ;(false); }");}catch(ex){}
try{eval("r");}catch(ex){}
...
try{eval("/*for..in*/for(var [let, window] = null in 1.2e3) continue L;");}catch(ex){}
...
try{eval("/*for..in*/M:for(var [functional, x] =  \"\" ++ in x) var x5 = functional, window\nthrow (-1);");}catch(ex){}
...
try{eval("/*for..in*/for(var x in window.x.((let (x =  /x/ , x) this ? ( get function::x(window, x) { return window.prototype } ) : 'fafafa'.replace(/a/g, function (x, prop)false)))) {with({}) { return\n(x); } /*for..in*/for(var \u3056 = ~x.isPrototypeOf((delete null)) in []) function (this, \u3056) { yield 033 }  }");}catch(ex){}
try{eval("/*for..in*/for(var x = ((window.watch(\"x\", [1,2,3,4].map) for (x in []) for (\u3056 in -0))) in this) var functional, x;");}catch(ex){}
try{eval("/*for..in*/for(var x in undefined) {}");}catch(ex){}
...
try{eval("continue L\n");}catch(ex){}
try{eval("/*for..in*/for(var x = (({functional: (-1)})) in 0/0) return 0;");}catch(ex){}
try{eval("M:if((let (x2, x) [[1]]) ? ((x = this) *= (({x: 1e81}))) : this) NaN = (this.zzz.zzz).throw( '' ) else  if ((false//h\n % true.prototype)) {}");}catch(ex){}
try{eval("return  /x/g ;");}catch(ex){}
try{eval("\nCollectGarbage()\n");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) /*for..in*/for(var this.x in false) {L: {} }");}catch(ex){}
try{eval("L: {CollectGarbage() }");}catch(ex){}
...
try{eval("/*for..in*/M:for(var [window, x] = x1.prop = <zzz>null</zzz>.( \n) in x.unwatch(\"\\u3056\") ^= - /x/ ) if((window)[delete this.zzz.zzz]) { if (x2.x) if((x for (NaN in -3/0))) {var x = function ([y]) { }, x; } else  if ( \"\"  % undefined)  else {functional, x1e4; }} else var x3;");}catch(ex){}
try{eval("do {/*for..in*/for(var x = ({}.hasOwnProperty(\"x2\")) in this.isPrototypeOf(window)) {CollectGarbage()[,]; } } while((this = window) && 0);");}catch(ex){}
...
try{eval("/*for..in*/M:for(var window in (([1,2,3,4].map)(\u3056 +  /x/g  <<=  '' )))");}catch(ex){}
...
try{eval("/*for..in*/for(var x3 in ((({}).hasOwnProperty)(({ x:  , x2: [] }) = ((\u3056 >= x) &= .2 *= ({}))[((new Function)(function::x))]))){var x = <x><y/></x>;return; }");}catch(ex){}
...
try{eval("");}catch(ex){}
try{eval("/*for..in*/M:for(var \u3056 = let (x) x5 in 1e-81 && [,,z1]) {var window, y;;{break L; } }");}catch(ex){}
try{eval("/*for..in*/M:for(var x.  in (<x><y/></x>.( '' ))) {throw -1;var {var window = window; } = window; }\n/*for..in*/for(var [x, x4] = x = window in /*\n*/[11,12,13,14].sort) \n");}catch(ex){}
try{eval("/*for..in*/L:for(var [functional] = ({x: false ?  /x/  :  \"\" }) in ((([,,z1] !== (-1)).unwatch(\"x5\"))(((x ||  '' ).yoyo(window ? ({a1:1}) : window).watch(\" \", x).x)))){return  /x/ ;;with((( \"\" )[true])){break L;{} } }");}catch(ex){}
try{eval("while((new Function({})) && 0){throw -0;(({a1:1})); }");}catch(ex){}
try{eval("throw x;");}catch(ex){}
try{eval("x =  ;");}catch(ex){}
try{eval("/*for..in*/L:for(var x = (x << [[1]]) in x3) {{}var x; }");}catch(ex){}
try{eval(";");}catch(ex){}
try{eval("while((0/0) && 0){\u000cbreak L;CollectGarbage() }");}catch(ex){}
try{eval("L: {eval([,,]); }//h\n");}catch(ex){}
try{eval("/*for..in*/for(var x in (((new Function(\"with({ : x.x5 = this}){; }\")))(null.prop))){throw 1e81;{} }");}catch(ex){}
...
try{eval("/*for..in*/for(var NaN =  /x/g  in x5) /a/gi");}catch(ex){}
try{eval("\n");}catch(ex){}
...
try{eval("if((undefined.eval((~(typeof void ({}) >>= 1e4)).prototype))) { if ((new (<ccc:ddd><x><y/></x></ccc:ddd>)() %  /x/  >>=  /x/ )) {/*for..in*/for(var [NaN, x] =  ''  ||  /x/g  || this.hasOwnProperty(\"x\") in true.watch(\"x\", /a/gi)) {CollectGarbage(){} }continue M; }} else if( \"\" ) { if (x2) \u3056 = null} else return;");}catch(ex){}
...
try{eval("if() { if ((({ set x2(x, x) { ((Math.pow).apply).call } , x setter: function  x (x3, x) { yield ({a2:z2}) }  }))) {([1,,]); }} else {/*for..in*/for(var x = this in true) [1,2,3,4].slicevar x4; }");}catch(ex){}
...
try{eval("/*for..in*/for(var [x, functional] = [11,12,13,14].some++ in ( ''  instanceof [,,])) ;");}catch(ex){}
try{eval("{; }");}catch(ex){}
try{eval("this.zzz.zzz;");}catch(ex){}
try{eval("{[[1]]; }");}catch(ex){}
try{eval("if((y\u0009.this.hasOwnProperty(\"x3\"))) {{ } } else {}");}catch(ex){}
try{eval("/*for..in*/for(var [this, functional] = (x4 .@  /x/g [-3/0]) in x1) {3;(this); }");}catch(ex){}
...
try{eval("/*for..in*/M:for(var x1 in x) {throw undefined;this; }");}catch(ex){}
try{eval("while(( .prototype = [z1,,].prototype) && 0){var x =  /x/ , y = null;null }");}catch(ex){}
try{eval("with('fafafa'.replace(/a/g, (function () { yield x4 } ).apply))/*for..in*/for(var this = this(x) %= (Iterator()) in true) {CollectGarbage() }");}catch(ex){}
try{eval("with({}) for(let y in []);");}catch(ex){}
try{eval("var y = this--;");}catch(ex){}
try{eval("for(let y in [5,6,7,8]) CollectGarbage()");}catch(ex){}
try{eval("/*for..in*/for(var [x4, x3] = (({})\n.valueOf(\"number\").watch(\"functional\", Math.pow)) in window = x) break L;");}catch(ex){}
try{eval("/*for..in*/for(var x in ((function (x) { return function ([y]) { } } )(false)))var x, NaN;");}catch(ex){}
