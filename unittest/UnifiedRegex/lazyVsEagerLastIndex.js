...
function Case0() {
    var r = /(?:ab|cd)\d?/g;
    var obj = {toString:function(){return "4";}};
    try {
        echo("About to set");
        r.lastIndex = obj;
        echo("About to exec");
        var executed = r.exec("aacd2233ab12nm444ab42");
        echo("About to get");
        echo("r.lastInddex = " + dump(r.lastIndex));
    }
    catch (e) {
        echo("Caught exception: " + e);
    }
}
echo("Case 0: valid toString, indirect");
Case0();

function Case1() {
    var r = /(?:ab|cd)\d?/g;
    var obj = {valueOf:function(){throw "THROWN!";}};
    try {
        echo("About to set");
        r.lastIndex = obj;
        echo("About to exec");
...
echo("Case 1: valueOf, indirect");
Case1();

function Case2() {
    var r = /(?:ab|cd)\d?/g;
    var obj = {toString:function(){throw "THROWN!";}};
    try {
        echo("About to set");
        r.lastIndex = obj;
        echo("About to exec");
...
function Case3() {
    ...
    try {
        echo("About to set");
        r.lastIndex = {toString:function(){throw "THROWN!";}};
        echo("About to exec");
        var executed = r.exec("aacd2233ab12nm444ab42");
        echo("About to get");
        echo("r.lastInddex = " + dump(r.lastIndex));
