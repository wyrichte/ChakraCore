// TODO[license]: Can this be moved to core\test and published to OSS with an appropriate license?
var data =
...
TraverseAndPrint("kraken l1:", data, false);
TraverseAndPrint("kraken l1+:", data, true, 1000);

function TraverseAndPrint(msg, str, doRecurse, loops) {
  loops = loops || 0;
  ...
  TraverseJSONObject(msg, 1, json, doRecurse, true);
  WScript.Echo("---------------");

  if (loops > 0) {
    WScript.Echo("Doing " + loops + " loop(s)");
...
function TraverseJSONObject(msg, level, o, doRecurse, doPrint) {
