...
replace(/b/, "abc", function () { return "$'"; });
replace(/b/, "abc", function () { return "$+"; });
replace(/b/, "abc", function () { return "$_"; });
replace(/b/, "abc", function () { return "$`$&$'"; });
replace(/b/, "abc", function () { return "1234567$"; });
replace(/b/, "abc", function () { return "$12345678"; });

echo("");

// Test the value of this inside the replace function
// It should be undefined in strict mode. In non-strict mode, we pass the function's source string as the this
replace(/b/, "abc", function() { if (this==undefined) return "pp"; else return "qq"; });
replace(/b/, "abc", function() { "use strict"; if (this==undefined) return "pp"; else return "qq"; });
