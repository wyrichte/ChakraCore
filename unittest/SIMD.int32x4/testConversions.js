...
function testFloat32x4Conversion() {
    ...
    equal(1.0, SIMD.Int32x4.extractLane(b, 0));
    equal(2.0, SIMD.Int32x4.extractLane(b, 1));
    equal(3.0, SIMD.Int32x4.extractLane(b, 2));
    equal(4.0, SIMD.Int32x4.extractLane(b, 3));
}
