...
namespace ChakraHost
{
    public static class Program
    {
        ...
        private static JavaScriptValue Echo(JavaScriptValue callee, bool isConstructCall, JavaScriptValue[] arguments, ushort argumentCount, IntPtr callbackState)
        {
        ...
        private static JavaScriptValue RunScript(JavaScriptValue callee, bool isConstructCall, JavaScriptValue[] arguments, ushort argumentCount, IntPtr callbackState)
        {
            if (argumentCount < 2)
            {
        ...
        private static void DefineHostCallback(JavaScriptValue globalObject, string callbackName, JavaScriptNativeFunction callback)
        {
            //
            // Get property ID.
            //
            ...
            JavaScriptValue function = JavaScriptValue.CreateFunction(callback);
        ...
        private static JavaScriptContext CreateHostContext(JavaScriptRuntime runtime, string[] arguments, int argumentsStart)
        {
            ...
            using (new JavaScriptContext.Scope(context))
            {
                ...
                DefineHostCallback(hostObject, "echo", Echo);
                DefineHostCallback(hostObject, "runScript", RunScript);
