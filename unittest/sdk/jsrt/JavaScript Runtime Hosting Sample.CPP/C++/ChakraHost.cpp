...
JsValueRef CALLBACK Echo(_In_ JsValueRef callee, _In_ bool isConstructCall, _In_ JsValueRef *arguments, _In_ unsigned short argumentCount, _In_opt_ void *callbackState)
{
...
JsValueRef CALLBACK RunScript(_In_ JsValueRef callee, _In_ bool isConstructCall, _In_ JsValueRef *arguments, _In_ unsigned short argumentCount, _In_opt_ void *callbackState)
{
...
int _cdecl wmain(int argc, wchar_t *argv[])
{
	...
	try
	{
		...
		fwprintf(stdout, L"chakrahost: script returned errorcode %d\n", returnValue);
