...
Namespace Hosting
    ...
    Public Structure JavaScriptValue
        ...
        ''' <returns>The new function object.</returns>
        Public Shared Function CreateFunction(nativeFunction As JavaScriptNativeFunction, callbackState As IntPtr) As JavaScriptValue
            Dim reference As JavaScriptValue
            ThrowIfError(JsCreateFunction(nativeFunction, callbackState, reference))
            Return reference
        End Function
