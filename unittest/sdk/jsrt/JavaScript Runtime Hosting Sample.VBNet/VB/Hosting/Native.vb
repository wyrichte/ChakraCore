...
Namespace Hosting
    ...
    Public Module Native
        ...
        Friend Declare Unicode Function JsCreateRuntime Lib "chakra.dll" (attributes As JavaScriptRuntimeAttributes, runtimeVersion As JavaScriptRuntimeVersion, threadService As JavaScriptThreadServiceCallback, ByRef runtime As JavaScriptRuntime) As JavaScriptErrorCode
        ...
        Friend Declare Unicode Function JsCreateContext Lib "chakra.dll" (runtime As JavaScriptRuntime, debugSite As IDebugApplication64, ByRef newContext As JavaScriptContext) As JavaScriptErrorCode

        Friend Declare Unicode Function JsCreateContext Lib "chakra.dll" (runtime As JavaScriptRuntime, debugSite As IDebugApplication32, ByRef newContext As JavaScriptContext) As JavaScriptErrorCode
        ...
        Friend Declare Unicode Function JsStartDebugging Lib "chakra.dll" (debugApplication As IDebugApplication64) As JavaScriptErrorCode

        Friend Declare Unicode Function JsStartDebugging Lib "chakra.dll" (debugApplication As IDebugApplication32) As JavaScriptErrorCode
        ...
        Friend Declare Unicode Function JsCreateFunction Lib "chakra.dll" (nativeFunction As JavaScriptNativeFunction, callbackState As IntPtr, ByRef func As JavaScriptValue) As JavaScriptErrorCode
