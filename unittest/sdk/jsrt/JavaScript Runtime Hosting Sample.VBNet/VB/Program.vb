...
Public Module Program
    ...
    Private Function Echo(callee As JavaScriptValue, isConstructCall As Boolean, arguments As JavaScriptValue(), argumentCount As UShort, callbackState As IntPtr) As JavaScriptValue
    ...
    Private Function RunScript(callee As JavaScriptValue, isConstructCall As Boolean, arguments As JavaScriptValue(), argumentCount As UShort, callbackState As IntPtr) As JavaScriptValue
    ...
    Private Sub DefineHostCallback(globalObject As JavaScriptValue, callbackName As String, callback As JavaScriptNativeFunction)
        '
        ' Get property ID.
        '
        ...
        Dim func As JavaScriptValue = JavaScriptValue.CreateFunction(callback)
    ...
    Private Function CreateHostContext(runtime As JavaScriptRuntime, arguments As String(), argumentsStart As Integer) As JavaScriptContext
        ...
        Using New JavaScriptContext.Scope(context)
            ...
            DefineHostCallback(hostObject, "echo", AddressOf Echo)
            DefineHostCallback(hostObject, "runScript", AddressOf RunScript)
    ...
    Public Function Main(arguments As String()) As Integer
        ...
        If arguments.Length - commandLineArguments.ArgumentsStart < 0 Or
           arguments.Length = 0 Then
        ...
        Try
            ...
            Using runtime
                ...
                Using New JavaScriptContext.Scope(context)
                    ...
                    Console.Out.WriteLine("chakrahost: script returned errorcode {0}", returnValue)
