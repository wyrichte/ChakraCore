function asmModule(stdlib, imports) {
	...
	function shuffle1()
    {
        ...
        while ( (loopIndex|0) < (loopCOUNT|0)) {
            ...
            xy = d2shuffle(g5, g6, 0,3);
			xx = d2shuffle(g5, g6, 0,2);
			yy = d2shuffle(g5, g6, 1,3);
			yx = d2shuffle(g5, g6, 1,2);
    ...
    function shuffle2()
    {
        ...
        {
            xy = d2shuffle(v1, v2, 0,3);
			xx = d2shuffle(v1, v2, 0,2);
			yy = d2shuffle(v1, v2, 1,3);
			yx = d2shuffle(v1, v2, 1,2);
        }
    ...
    function shuffle3()
    {
        ...
        do {
            ...
            xy = d2shuffle( d2add(v1, g5), g6, 0,3);
			xx = d2shuffle( d2mul(v1, g5), g6, 0,2);
			yy = d2shuffle( d2sub(v1, g5), g6, 1,3);
			yx = d2shuffle( g5, v1,            1,2);
