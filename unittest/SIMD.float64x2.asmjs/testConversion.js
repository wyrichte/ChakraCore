function asmModule(stdlib, imports) {
    ...
    {
        var x = d2(0.0,0.0);
        var y = f4(21.54, 2.334,48458.234,358991.23);
    ...
    function conv2()
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            x = d2fromFloat32x4(globImportF4);
    ...
    function conv5()
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            x = d2fromFloat32x4Bits(globImportF4);
    ...
    function conv11()
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            x = d2fromInt32x4Bits(globImportI4);
