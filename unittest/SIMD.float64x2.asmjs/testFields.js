function asmModule(stdlib, imports) {
    ...
    {
        a = a|0;
        var b = f4(5033.2,-3401.0, -34183.8985, 212344.12);
        var c = d2(-34183.8985, 212344.12);
        var loopIndex = 0;
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            c = d2( d2g1.x * (+(b.w)), +(fround(f4g2.z / b.z)));
    ...
    function func3(a)
    {
        ...
        do {
            ...
            globImportD2 = d2(+(fround(globImportF4.x + fround(2.0))), 4.0 * globImportD2.y);
        ...
        return d2(globImportD2);
    }
    
    function func4(a)
    {
        a = a|0;
        var b = f4(5033.2,-3401.0, -34183.1, 212344.5);
        var c = d2(-34183.8985, 212344.12);
    ...
    function func6(a)
    {
        ...
        do {
            ...
            globImportD2 = d2(+fround(fround(-globImportF4.x) - fround(2.0)), +fround(fround(4.0) * globImportF4.y));
            a = globImportD2.signMask;
