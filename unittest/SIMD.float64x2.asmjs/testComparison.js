function asmModule(stdlib, imports) {
    ...
    function func2(a)
    {
        ...
        for (loopIndex = 0; (loopIndex | 0) < (loopCOUNT | 0) ; loopIndex = (loopIndex + 1) | 0)
        {
            ...
            if (a == 0)
            {
                d = d2lessThan(d2g1, d2g2);
                
            } else if (a == 1)
            {
                d = d2lessThanOrEqual(d2g1, d2g2);
            } else if (a == 2)
            {
                d = d2equal(d2g1, d2g2);
            } else if (a == 3)
            {
                d = d2notEqual(d2g1, d2g2);
            } else if (a == 4)
            {
                d = d2greaterThanOrEqual(d2g1, d2g2);
            } else if (a == 5)
            {
                d = d2greaterThan(d2g1, d2g2);
            }
    ...
    function func3(a)
    {
        ...
        do {
            ...
            if (a == 0)
            {
                globImportI4 = d2lessThan(globImportD2, d2g2);
                
            } else if (a == 1)
            {
                globImportI4 = d2lessThanOrEqual(globImportD2, d2g2);
            } else if (a == 2)
            {
                globImportI4 = d2equal(globImportD2, d2g2);
            } else if (a == 3)
            {
                globImportI4 = d2notEqual(globImportD2, d2g2);
            } else if (a == 4)
            {
                globImportI4 = d2greaterThanOrEqual(globImportD2, d2g2);
            } else if (a == 5)
            {
                globImportI4 = d2greaterThan(globImportD2, d2g2);
            }
