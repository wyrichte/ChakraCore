...
void RunGetExtendedExceptionInfoTests(MyScriptDirectTests* mytest)
{
    ...
    WCHAR* throwOOMSO1 = _u("var OOMnums = 0;\n var OOM = (function() {\n    var a = new Array();\n    a[0] = 'string';\n    a[1] = 'aaa';\n    var i = 2;\n    return function() {\n        if (OOMnums++ > 50) return;\n        for (;;i++) {\n            a[i] = a[i-1] + a[i-2];\n        }\n    };\n})();\n\nfunction foo() \n{\n    try \n    {\n        foo(); \n    }\n    finally\n    {\n        OOM();\n    }\n}\nfoo();");
    ...
    OnScriptErrorTest OOMTest2 = OnScriptErrorTest("TestOnScriptErrorGetsExpectedStackTraceOnOOMSO1", TestOnScriptErrorGetsExpectedCallStack_Callback<T, 3, greaterThan, noDumpStack, false>);
