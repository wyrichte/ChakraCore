...
public:
    ...
    static Var Echo(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var Quit(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdErrWriteLine(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdErrWrite(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdOutWriteLine(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdOutWrite(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdInReadLine(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StdInEOF(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var LoadScriptFile(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var LoadScript(Var function, CallInfo callInfo, Var thisArg, ...);
    ...
    static Var InitializeProjection(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var RegisterCrossThreadInterfacePS(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var GetWorkingSet(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var CopyOnWrite(Var function, CallInfo callInfo, Var thisArg,...);
    static Var CreateCanvasPixelArray(Var function, CallInfo callInfo, Var thisArg,...);
    static Var Shutdown(Var function, CallInfo callInfo, Var thisArg,...);
    static Var PerformSourceRundown(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var DebugDynamicAttach(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var DebugDynamicDetach(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var Edit(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StartScriptProfiler(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var StopScriptProfiler(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var SetTimeout(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var ClearTimeout(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var EmitStackTraceEvent(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var CallFunction(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var SetEvalEnabled(Var function, CallInfo callInfo, Var thisArg, ...); 
    static Var SetRestrictedMode(Var function, CallInfo callInfo, Var thisArg, ...);
    static Var TestConstructor(Var function, CallInfo callInfo, Var thisArg, ...);
