...
rem Encode a file so it can be #included as a WCHAR array in C++
...
call %1 -p -e "s/(.)/L'\1',/g" < %2 > "%~3.temp1"
call %1 -p -e "s/\\/\\\\/g"    < "%~3.temp1" > "%~3.temp2"
call %1 -p -e "s/'('|\x22)'/'\\\1'/g"  < "%~3.temp2" > "%~3.temp1"
call %1 -p -e "s/\r?\n/L'\\r',L'\\n',\n/g" < "%~3.temp1" > %3
