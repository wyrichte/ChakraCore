    ...
    __out Var* instance)
{
    ...
    *instance = nullptr;
    ...
    BEGIN_JS_RUNTIME_CALL_EX_AND_TRANSLATE_EXCEPTION_AND_ERROROBJECT_TO_HRESULT(scriptContext, false)
    {
        *instance = library->CreateExternalConstructor((Js::JavascriptMethod)entryPoint, nameId, prototype == nullptr ? nullptr : Js::RecyclableObject::FromVar(prototype));
    ...
    __out Var* instance)
{
    ...
    *instance = nullptr;
    ...
    BEGIN_JS_RUNTIME_CALL_EX_AND_TRANSLATE_EXCEPTION_AND_ERROROBJECT_TO_HRESULT(scriptContext, false)
    {
        *instance = library->CreateExternalConstructor((Js::JavascriptMethod)entryPoint, nameId, method, deferredTypeSlots, (hasAccessors != FALSE));
    ...
    __out HTYPE* typeRef)
{
    ...
    else
    {
        Js::ExternalType * externalType = RecyclerNew(recycler, Js::ExternalType,
            localScriptContext, (Js::TypeId)typeId, objPrototype, (Js::JavascriptMethod)entryPoint,
