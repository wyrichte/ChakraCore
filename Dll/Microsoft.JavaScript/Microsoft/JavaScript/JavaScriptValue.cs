// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JavaScriptValue.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public struct JavaScriptValue
    {
        ...
        public bool IsValid
        {
            get { return this.reference != IntPtr.Zero; }
        }
        ...
        public static JavaScriptValue New(bool value)
        {
        ...
        public static JavaScriptValue New(double value)
        {
            JavaScriptValue reference;
        ...
        /// <param name="value">The value to be converted.</param>
        /// <returns>The new <c>Number</c> value.</returns>
        public static JavaScriptValue New(int value)
        {
            JavaScriptValue reference;
        ...
        public static JavaScriptValue New(string value)
        {
            JavaScriptValue reference;
        ...
        public static JavaScriptValue New(object value)
        {
            JavaScriptValue reference;
        ...
        public static JavaScriptValue NewObject()
        {
            JavaScriptValue reference;
        ...
        /// </param>
        /// <returns>The new <c>Object</c>.</returns>
        public static JavaScriptValue NewExternalObject(IntPtr data, JavaScriptObjectFinalizeCallback finalizer)
        {
            JavaScriptValue reference;
        ...
        public static JavaScriptValue NewFunction(JavaScriptNativeFunction function, IntPtr callbackState)
        {
            JavaScriptValue reference;
            Native.ThrowIfError(Native.JsCreateFunction(function, callbackState, out reference));
            return reference;
        }
        ...
        public static JavaScriptValue NewArray(uint length)
        {
            JavaScriptValue reference;
        ...
        public static JavaScriptValue NewError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        public static JavaScriptValue NewRangeError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        public static JavaScriptValue NewReferenceError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        public static JavaScriptValue NewSyntaxError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        public static JavaScriptValue NewTypeError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        public static JavaScriptValue NewUriError(JavaScriptValue message)
        {
            JavaScriptValue reference;
