// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JavaScriptRuntime.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public struct JavaScriptRuntime : IDisposable
    {
        ...
        public static JavaScriptRuntime New(JavaScriptRuntimeAttributes attributes, JavaScriptThreadServiceCallback threadServiceCallback)
        {
        ...
        /// <param name="attributes">The attributes of the runtime to be created.</param>
        /// <returns>The runtime created.</returns>
        public static JavaScriptRuntime New(JavaScriptRuntimeAttributes attributes)
        {
        ...
        /// </summary>
        /// <returns>The runtime created.</returns>
        public static JavaScriptRuntime New()
        {
            return New(JavaScriptRuntimeAttributes.None, null);
        }
        ...
        public JavaScriptContext NewContext()
        {
