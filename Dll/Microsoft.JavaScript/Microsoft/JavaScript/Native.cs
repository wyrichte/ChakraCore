// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Native.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public static class Native
    {
        ...
        [DllImport("chakra.dll")]
        internal static extern JavaScriptErrorCode JsStopDebugging();
        ...
        [DllImport("chakra.dll")]
        internal static extern JavaScriptErrorCode JsCreateFunction(JavaScriptNativeFunction nativeFunction, IntPtr callbackState, out JavaScriptValue function);
