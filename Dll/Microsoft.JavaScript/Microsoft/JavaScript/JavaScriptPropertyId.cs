// --------------------------------------------------------------------------------------------------------------------
// <copyright file="JavaScriptPropertyId.cs" company="Microsoft Corporation">
...
namespace Microsoft.JavaScript
{
    ...
    public struct JavaScriptPropertyId : IEquatable<JavaScriptPropertyId>
    {
        ...
        public static JavaScriptPropertyId New(string name)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is JavaScriptPropertyId && this.Equals((JavaScriptPropertyId)obj);
        }
